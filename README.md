...
![Total Stars](https://img.shields.io/badge/total%20stars-4,962,579-gold)
...
- [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`158,921`
- [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`41,100`
- [tmc/langchaingo](https://github.com/tmc/langchaingo) — LangChain for Go, the easiest way to write LLM-based programs in Go ☆`8,380`
...
- [otiai10/gosseract](https://github.com/otiai10/gosseract) — OCR using Tesseract in Go ☆`3,043`
...
- [knights-analytics/hugot](https://github.com/knights-analytics/hugot) — Onnx transformer pipelines in Golang ☆`533`
- [c-bata/goptuna](https://github.com/c-bata/goptuna) — A hyperparameter optimization framework, inspired by Optuna. ☆`273`
## Audio & Video

### Audio

- [ebitengine/oto](https://github.com/ebitengine/oto) — A low-level library to play sound on multiple platforms ☆`1,839`
...
- [hybridgroup/gocv](https://github.com/hybridgroup/gocv) — Computer vision with OpenCV 4 ☆`7,338`
...
- [golang-jwt/jwt](https://github.com/golang-jwt/jwt) — Go implementation of JSON Web Tokens (JWT). ☆`8,815`
- [markbates/goth](https://github.com/markbates/goth) — Multi-provider authentication ☆`6,401`
- [golang/oauth2](https://github.com/golang/oauth2) — Go OAuth2 ☆`5,796`
- [aarondl/authboss](https://github.com/aarondl/authboss) — The boss of http auth. ☆`4,138`
- [alexedwards/scs](https://github.com/alexedwards/scs) — HTTP Session Management for Go ☆`2,498`
...
- [go-jose/go-jose](https://github.com/go-jose/go-jose) — An implementation of JOSE standards (JWE, JWS, JWT) in Go ☆`472`
...
- [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,667`
- [ory/keto](https://github.com/ory/keto) — Customizable permission server ☆`5,237`
- [openfga/openfga](https://github.com/openfga/openfga) — Fine-grained authorization server ☆`4,609`
- [cerbos/cerbos](https://github.com/cerbos/cerbos) — Open core authorization layer ☆`4,182`
## Bots & Chat

### Bot Frameworks

- [tucnak/telebot](https://github.com/tucnak/telebot) — Telebot is a Telegram bot framework in Go. ☆`4,520`
- [go-telegram/bot](https://github.com/go-telegram/bot) — Telegram Bot API Go framework ☆`1,521`
- [mymmrac/telego](https://github.com/mymmrac/telego) — Telegram Bot API library for Go ☆`864`
...
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`37,991`
- [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,151`
- [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,504`
...
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) — Style definitions for nice terminal layouts ☆`10,263`
- [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) — TUI components for Bubble Tea ☆`7,472`
- [c-bata/go-prompt](https://github.com/c-bata/go-prompt) — Interactive prompts for Go ☆`5,448`
- [pterm/pterm](https://github.com/pterm/pterm) — Modern terminal output library ☆`5,329`
- [schollz/progressbar](https://github.com/schollz/progressbar) — Thread-safe progress bar ☆`4,628`
- [mum4k/termdash](https://github.com/mum4k/termdash) — Terminal-based dashboard ☆`2,961`
...
- [muesli/termenv](https://github.com/muesli/termenv) — Terminal color support ☆`1,952`
...
- [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,814`
- [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,800`
...
- [carapace-sh/carapace-bin](https://github.com/carapace-sh/carapace-bin) — Multi-shell completion binary ☆`1,641`
- [nanovms/ops](https://github.com/nanovms/ops) — Build and run unikernels ☆`1,448`
- [carapace-sh/carapace](https://github.com/carapace-sh/carapace) — Multi-shell completion library ☆`1,074`
...
- [anthdm/hollywood](https://github.com/anthdm/hollywood) — Blazingly fast and light-weight Actor engine written in Golang ☆`2,163`
...
- [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,794`
- [caarlos0/env](https://github.com/caarlos0/env) — Parse environment variables to structs ☆`5,918`
- [knadh/koanf](https://github.com/knadh/koanf) — Lightweight config management ☆`3,733`
- [alecthomas/kong](https://github.com/alecthomas/kong) — Command-line parser for Go ☆`2,914`
- [ilyakaznacheev/cleanenv](https://github.com/ilyakaznacheev/cleanenv) — Minimalistic environment config reader ☆`2,027`
...
- [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,392`
- [bytedance/sonic](https://github.com/bytedance/sonic) — A blazingly fast JSON serializing & deserializing library ☆`9,008`
...
- [fxamacker/cbor](https://github.com/fxamacker/cbor) — CBOR codec with extensions ☆`1,005`
...
- [tylertreat/BoomFilters](https://github.com/tylertreat/BoomFilters) — Probabilistic data structures for streams ☆`1,631`
- [seiflotfy/cuckoofilter](https://github.com/seiflotfy/cuckoofilter) — Cuckoo Filter: Practically Better Than Bloom ☆`1,209`
...
- [bits-and-blooms/bitset](https://github.com/bits-and-blooms/bitset) — Go package implementing bitsets ☆`1,474`
...
- [golang/groupcache](https://github.com/golang/groupcache) — Distributed cache library ☆`13,300`
- [dgraph-io/ristretto](https://github.com/dgraph-io/ristretto) — A high performance memory-bound Go cache ☆`6,650`
...
- [maypok86/otter](https://github.com/maypok86/otter) — A high performance caching library for Go ☆`2,475`
...
- [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,902`
- [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,528`
- [pressly/goose](https://github.com/pressly/goose) — A database migration tool. Supports SQL migrations and Go functions. ☆`9,914`
- [ariga/atlas](https://github.com/ariga/atlas) — Declarative schema migrations with schema-as-code workflows ☆`7,841`
- [amacneil/dbmate](https://github.com/amacneil/dbmate) — A lightweight, framework-agnostic database migration tool. ☆`6,611`
...
- [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`20,607`
- [sosedoff/pgweb](https://github.com/sosedoff/pgweb) — Cross-platform client for PostgreSQL databases ☆`9,206`
...
- [cybertec-postgresql/pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) — Advanced PostgreSQL scheduler ☆`1,306`
- [liweiyi88/onedump](https://github.com/liweiyi88/onedump) — Effortless database administration tool ☆`801`
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`62,087`
- [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`42,093`
- [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,563`
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,701`
- [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,071`
- [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,446`
- [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,518`
- [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,220`
- [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,891`
- [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,350`
- [etcd-io/bbolt](https://github.com/etcd-io/bbolt) — An embedded key/value database for Go. ☆`9,295`
...
- [nalgeon/redka](https://github.com/nalgeon/redka) — Redis re-implemented with SQL ☆`4,437`
- [HDT3213/godis](https://github.com/HDT3213/godis) — A Golang implemented Redis Server and Cluster ☆`3,816`
...
- [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,783`
...
- [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,350`
- [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`16,819`
- [aarondl/sqlboiler](https://github.com/aarondl/sqlboiler) — Generate a Go ORM tailored to your database schema. ☆`6,970`
- [uptrace/bun](https://github.com/uptrace/bun) — SQL-first Golang ORM ☆`4,587`
- [upper/db](https://github.com/upper/db) — Data access layer for databases ☆`3,632`
- [huandu/go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) — SQL builder with zero-config ORM ☆`1,653`
- [stephenafamo/bob](https://github.com/stephenafamo/bob) — SQL builder with ORM generator ☆`1,589`
...
- [99designs/gqlgen](https://github.com/99designs/gqlgen) — go generate based graphql server library ☆`10,624`
- [TomWright/dasel](https://github.com/TomWright/dasel) — Query and modify data formats ☆`7,774`
...
- [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) — MySQL driver for database/sql ☆`15,370`
- [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,133`
- [denisenkom/go-mssqldb](https://github.com/denisenkom/go-mssqldb) — Microsoft SQL server driver written in go language ☆`1,877`
- [ncruces/go-sqlite3](https://github.com/ncruces/go-sqlite3) — Go bindings to SQLite using wazero ☆`892`
...
- [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,666`
...
- [go-jet/jet](https://github.com/go-jet/jet) — Type-safe SQL builder with codegen ☆`3,520`
- [doug-martin/goqu](https://github.com/doug-martin/goqu) — SQL builder and query library for golang ☆`2,623`
...
- [sourcegraph/zoekt](https://github.com/sourcegraph/zoekt) — Fast trigram-based code search ☆`1,324`
...
- [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,626`
- [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,537`
...
- [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`33,778`
- [woodpecker-ci/woodpecker](https://github.com/woodpecker-ci/woodpecker) — Simple, powerful CI/CD engine ☆`6,211`
...
- [TwiN/gatus](https://github.com/TwiN/gatus) — Automated developer-oriented status page with alerting and incident support ☆`9,556`
...
- [gabrie30/ghorg](https://github.com/gabrie30/ghorg) — Clone entire GitHub orgs ☆`1,923`
- [sanbornm/go-selfupdate](https://github.com/sanbornm/go-selfupdate) — Enable your Go applications to self update ☆`1,663`
...
- [aptly-dev/aptly](https://github.com/aptly-dev/aptly) — aptly - Debian repository management tool ☆`2,745`
- [KusionStack/kusion](https://github.com/KusionStack/kusion) — Declarative platform orchestrator ☆`1,245`
- [oxyno-zeta/s3-proxy](https://github.com/oxyno-zeta/s3-proxy) — S3 reverse proxy with auth ☆`427`
### Kubernetes
...
- [stefanprodan/podinfo](https://github.com/stefanprodan/podinfo) — Go microservice template for Kubernetes ☆`5,809`
...
- [tsenart/vegeta](https://github.com/tsenart/vegeta) — HTTP load testing tool and library. It's over 9000! ☆`24,820`
- [codesenberg/bombardier](https://github.com/codesenberg/bombardier) — Fast cross-platform HTTP benchmarking tool written in Go ☆`6,686`
...
- [axllent/mailpit](https://github.com/axllent/mailpit) — An email and SMTP testing tool with API for developers ☆`8,408`
...
- [AfterShip/email-verifier](https://github.com/AfterShip/email-verifier) — Email verification without sending emails ☆`1,492`
- [wneessen/go-mail](https://github.com/wneessen/go-mail) — Easy to use, yet comprehensive library for sending mails with Go ☆`1,231`
...
- [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,636`
- [ipfs/kubo](https://github.com/ipfs/kubo) — An IPFS implementation in Go ☆`16,869`
- [lightningnetwork/lnd](https://github.com/lightningnetwork/lnd) — Lightning Network Daemon ☆`8,086`
- [cosmos/cosmos-sdk](https://github.com/cosmos/cosmos-sdk) — A Framework for Building High Value Public Blockchains ☆`6,895`
...
- [achannarasappa/ticker](https://github.com/achannarasappa/ticker) — Terminal stock and crypto tracker ☆`5,871`
...
- [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,740`
- [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,780`
- [therecipe/qt](https://github.com/therecipe/qt) — Qt bindings for Go ☆`10,769`
- [go-vgo/robotgo](https://github.com/go-vgo/robotgo) — Cross-platform RPA and GUI automation ☆`10,560`
...
- [ncruces/zenity](https://github.com/ncruces/zenity) — Zenity dialogs for Golang, Windows, macOS ☆`883`
...
- [richardwilkes/unison](https://github.com/richardwilkes/unison) — Unified GUI toolkit for Go ☆`312`
### Windows
...
- [gen2brain/raylib-go](https://github.com/gen2brain/raylib-go) — Go bindings for raylib ☆`2,307`
...
- [mlange-42/ark](https://github.com/mlange-42/ark) — Ark -- Archetype-based Entity Component System (ECS) for Go. ☆`197`
...
- [tidwall/tile38](https://github.com/tidwall/tile38) — Real-time Geospatial and Geofencing ☆`9,555`
...
- [golang/vscode-go](https://github.com/golang/vscode-go) — Go extension for Visual Studio Code ☆`4,174`
...
- [Zxilly/go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) — Analyze compiled Go binary size ☆`1,872`
...
- [safedep/vet](https://github.com/safedep/vet) — Protect against malicious open source packages ☆`930`
...
- [shirou/gopsutil](https://github.com/shirou/gopsutil) — psutil for golang ☆`11,645`
- [arduino/arduino-cli](https://github.com/arduino/arduino-cli) — Arduino command line tool ☆`4,762`
- [jaypipes/ghw](https://github.com/jaypipes/ghw) — Go HardWare discovery/inspection library ☆`1,806`
...
- [rulego/rulego](https://github.com/rulego/rulego) — Lightweight rule engine framework ☆`1,395`
...
- [hashicorp/raft](https://github.com/hashicorp/raft) — Golang implementation of the Raft consensus protocol ☆`8,889`
- [lni/dragonboat](https://github.com/lni/dragonboat) — Multi-group Raft consensus library ☆`5,289`
- [etcd-io/raft](https://github.com/etcd-io/raft) — Raft library for maintaining a replicated state machine ☆`971`
- [vadiminshakov/committer](https://github.com/vadiminshakov/committer) — 2PC and 3PC protocols for Go ☆`41`
### DNS

- [miekg/dns](https://github.com/miekg/dns) — DNS library in Go ☆`8,604`
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) — DNS ad-blocker for local networks ☆`5,868`
...
- [temporalio/sdk-go](https://github.com/temporalio/sdk-go) — Temporal Go SDK ☆`795`
...
- [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,191`
- [elazarl/goproxy](https://github.com/elazarl/goproxy) — An HTTP proxy library for Go ☆`6,557`
...
- [go-resty/resty](https://github.com/go-resty/resty) — Simple HTTP, REST, and SSE client library for Go ☆`11,455`
...
- [bogdanfinn/tls-client](https://github.com/bogdanfinn/tls-client) — HTTP client with TLS fingerprint spoofing ☆`1,397`
...
- [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`11,551`
...
- [charmbracelet/wish](https://github.com/charmbracelet/wish) — Make SSH apps, just like that! ☆`4,688`
- [getfider/fider](https://github.com/getfider/fider) — Open platform to collect and prioritize feedback ☆`3,984`
...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) — Open source feature flag solution ☆`1,898`
...
- [fortio/fortio](https://github.com/fortio/fortio) — Load testing and echo server ☆`3,658`
...
- [anacrolix/torrent](https://github.com/anacrolix/torrent) — Full-featured BitTorrent client package and utilities ☆`5,926`
...
- [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`15,888`
- [quic-go/quic-go](https://github.com/quic-go/quic-go) — A production-ready QUIC implementation in pure Go ☆`11,297`
- [google/gopacket](https://github.com/google/gopacket) — Provides packet processing capabilities for Go ☆`6,708`
- [osrg/gobgp](https://github.com/osrg/gobgp) — BGP implemented in the Go Programming Language ☆`3,948`
...
- [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,694`
...
- [gliderlabs/ssh](https://github.com/gliderlabs/ssh) — Easy SSH servers in Golang ☆`4,057`
...
- [xtaci/kcptun](https://github.com/xtaci/kcptun) — Quantum-safe secure tunnel ☆`14,367`
- [panjf2000/gnet](https://github.com/panjf2000/gnet) — High-performance event-loop network ☆`11,027`
- [cloudwego/netpoll](https://github.com/cloudwego/netpoll) — High-performance I/O framework ☆`4,509`
- [xtaci/kcp-go](https://github.com/xtaci/kcp-go) — A crypto-secure Reliable-UDP library for Golang with FEC support. ☆`4,378`
- [lesismal/nbio](https://github.com/lesismal/nbio) — High-performance network library ☆`2,690`
- [Allenxuxu/gev](https://github.com/Allenxuxu/gev) — Lightweight non-blocking TCP library ☆`1,771`
- [xtaci/gaio](https://github.com/xtaci/gaio) — High-performance, minimalist async-io (proactor) networking for Golang. ☆`816`
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,575`
- [xjasonlyu/tun2socks](https://github.com/xjasonlyu/tun2socks) — TUN to SOCKS proxy ☆`4,782`
- [songgao/water](https://github.com/songgao/water) — A simple TUN/TAP library written in native Go. ☆`2,115`
- [yosebyte/nodepass](https://github.com/yosebyte/nodepass) — Secure TCP/UDP tunneling with TLS ☆`1,973`
## Queues & Pub/Sub

### Brokers

- [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,926`
- [emitter-io/emitter](https://github.com/emitter-io/emitter) — High-performance pub/sub broker ☆`3,996`
- [mochi-mqtt/server](https://github.com/mochi-mqtt/server) — Embeddable MQTT v5 broker ☆`1,758`
### Clients & Libraries

- [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,707`
- [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,369`
- [centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) — Scalable real-time messaging server ☆`9,700`
- [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) — Building event-driven applications the easy way in Go. ☆`9,391`
- [appleboy/gorush](https://github.com/appleboy/gorush) — A push notification server written in Go (Golang). ☆`8,665`
- [RichardKnop/machinery](https://github.com/RichardKnop/machinery) — Async task queue with message passing ☆`7,925`
- [nats-io/nats.go](https://github.com/nats-io/nats.go) — Golang client for NATS, the cloud native messaging system. ☆`6,351`
- [dunglas/mercure](https://github.com/dunglas/mercure) — Server-Sent Events hub ☆`5,155`
...
- [olahol/melody](https://github.com/olahol/melody) — Minimalist websocket framework for Go ☆`4,043`
...
- [containrrr/shoutrrr](https://github.com/containrrr/shoutrrr) — Notification library for gophers and their furry friends. ☆`1,456`
...
- [paulmach/orb](https://github.com/paulmach/orb) — 2D geometry types and utilities ☆`1,077`
...
- [php/frankenphp](https://github.com/php/frankenphp) — The modern PHP app server ☆`10,613`
- [expr-lang/expr](https://github.com/expr-lang/expr) — Expression evaluation for Go ☆`7,584`
- [yuin/gopher-lua](https://github.com/yuin/gopher-lua) — Lua VM and compiler in Go ☆`6,816`
- [dop251/goja](https://github.com/dop251/goja) — ECMAScript engine in pure Go ☆`6,674`
...
- [google/cel-go](https://github.com/google/cel-go) — Common Expression Language for Go ☆`2,814`
...
- [oapi-codegen/oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) — Generate Go code from OpenAPI 3 specs ☆`7,950`
...
- [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,868`
- [authzed/spicedb](https://github.com/authzed/spicedb) — Zanzibar-inspired permissions DB ☆`6,324`
...
- [Ullaakut/cameradar](https://github.com/Ullaakut/cameradar) — Cameradar hacks its way into RTSP videosurveillance cameras ☆`4,816`
- [corazawaf/coraza](https://github.com/corazawaf/coraza) — ModSecurity-compatible WAF in Go ☆`3,184`
...
- [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) — AI-powered honeypot framework ☆`1,802`
...
- [boyter/scc](https://github.com/boyter/scc) — Fast code counter and stats ☆`7,935`
- [mgechev/revive](https://github.com/mgechev/revive) — Fast, extensible Go linter ☆`5,377`
...
- [daveshanley/vacuum](https://github.com/daveshanley/vacuum) — Fast OpenAPI linter ☆`978`
...
- [brianvoe/gofakeit](https://github.com/brianvoe/gofakeit) — Random fake data generator written in go ☆`5,277`
...
- [pixie-io/pixie](https://github.com/pixie-io/pixie) — Kubernetes-native observability ☆`6,310`
- [arl/statsviz](https://github.com/arl/statsviz) — Visualize Go runtime metrics ☆`3,611`
...
- [sensepost/gowitness](https://github.com/sensepost/gowitness) — Web screenshot utility with Chrome ☆`4,112`
...
- [fergusstrange/embedded-postgres](https://github.com/fergusstrange/embedded-postgres) — Embedded PostgreSQL for testing ☆`1,100`
...
- [ikawaha/kagome](https://github.com/ikawaha/kagome) — Japanese morphological analyzer ☆`931`
...
- [blevesearch/bleve](https://github.com/blevesearch/bleve) — Text/numeric/geo/vector indexing library ☆`10,876`
...
- [nicksnyder/go-i18n](https://github.com/nicksnyder/go-i18n) — Translate Go programs ☆`3,436`
...
- [goforj/godump](https://github.com/goforj/godump) — Pretty-printer for Go structs ☆`1,552`
...
- [dromara/carbon](https://github.com/dromara/carbon) — Developer-friendly time package ☆`5,197`
...
- [cockroachdb/errors](https://github.com/cockroachdb/errors) — Error library with portability ☆`2,338`
- [rotisserie/eris](https://github.com/rotisserie/eris) — Errors with readable stack traces ☆`1,754`
...
- [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,733`
- [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,157`
- [pdfcpu/pdfcpu](https://github.com/pdfcpu/pdfcpu) — PDF processor in Go ☆`8,345`
- [spf13/afero](https://github.com/spf13/afero) — Filesystem abstraction for Go ☆`6,512`
- [dundee/gdu](https://github.com/dundee/gdu) — Fast disk usage analyzer ☆`5,204`
- [unidoc/unioffice](https://github.com/unidoc/unioffice) — Office document library ☆`4,765`
...
- [gen2brain/go-unarr](https://github.com/gen2brain/go-unarr) — Decompression library bindings ☆`301`
...
- [samber/mo](https://github.com/samber/mo) — Monads and FP for Go ☆`3,265`
...
- [wabarc/wayback](https://github.com/wabarc/wayback) — Web archiving tool with IM interface ☆`2,121`
...
- [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,651`
- [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,102`
...
- [gookit/slog](https://github.com/gookit/slog) — Configurable logging library ☆`526`
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,936`
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) — Spin up Go projects with popular frameworks ☆`8,553`
...
- [mikestefanello/pagoda](https://github.com/mikestefanello/pagoda) — Full-stack web development starter kit ☆`2,888`
...
- [abhimanyu003/sttr](https://github.com/abhimanyu003/sttr) — CLI string operations ☆`1,268`
...
- [cilium/ebpf](https://github.com/cilium/ebpf) — eBPF library for Go ☆`7,434`
...
- [anchore/syft](https://github.com/anchore/syft) — SBOM generator for containers ☆`8,191`
...
- [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,413`
- [go-kit/kit](https://github.com/go-kit/kit) — A standard library for microservices. ☆`27,577`
- [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,311`
- [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,660`
...
- [go-dev-frame/sponge](https://github.com/go-dev-frame/sponge) — Code generation framework for Go ☆`2,751`
...
- [rs/cors](https://github.com/rs/cors) — Go net/http configurable handler to handle CORS requests ☆`2,847`
...
- [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,288`
...
- [johnfercher/maroto](https://github.com/johnfercher/maroto) — Create PDFs with Bootstrap grid ☆`2,609`
...
- [apache/dubbo-go](https://github.com/apache/dubbo-go) — Go Implementation For Apache Dubbo . ☆`4,875`
...
- [go-co-op/gocron](https://github.com/go-co-op/gocron) — Easy and fluent Go cron scheduling ☆`6,840`
- [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) — Run Background Tasks at Scale ☆`6,416`
...
1. [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`158,921`
...
1. [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`62,087`
...
1. [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,936`
...
1. [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,636`
1. [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,814`
1. [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`42,093`
1. [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`41,100`
1. [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,563`
1. [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,350`
1. [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,917`
1. [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`37,991`
1. [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`33,778`
1. [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,733`
1. [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,413`
...
1. [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,701`
...
1. [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,071`
1. [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,794`
...
1. [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,740`
1. [go-kit/kit](https://github.com/go-kit/kit) — A standard library for microservices. ☆`27,577`
1. [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,651`
1. [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,598`
1. [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,311`
1. [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`24,979`
1. [tsenart/vegeta](https://github.com/tsenart/vegeta) — HTTP load testing tool and library. It's over 9000! ☆`24,820`
1. [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,102`
1. [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,800`
1. [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,191`
1. [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,694`
1. [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,660`
1. [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,626`
1. [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,319`
1. [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,783`
1. [gorilla/mux](https://github.com/gorilla/mux) — Powerful HTTP router ☆`21,759`
1. [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,446`
1. [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,288`
1. [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,868`
1. [samber/lo](https://github.com/samber/lo) — Lodash-style utilities for Go ☆`20,828`
1. [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`20,607`
1. [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,157`
1. [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,151`
1. [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,667`
1. [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,552`
1. [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,518`
1. [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,926`
1. [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`18,260`
1. [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,902`
1. [jmoiron/sqlx](https://github.com/jmoiron/sqlx) — Extensions for database/sql ☆`17,444`
1. [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,220`
...
1. [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`16,819`
1. [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,666`
1. [fatih/vim-go](https://github.com/fatih/vim-go) — Go development plugin for Vim ☆`16,223`
1. [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,891`
1. [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`15,888`
...
1. [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,392`
1. [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) — MySQL driver for database/sql ☆`15,370`
1. [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,350`
...
1. [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,537`
1. [xtaci/kcptun](https://github.com/xtaci/kcptun) — Quantum-safe secure tunnel ☆`14,367`
1. [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,241`
1. [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,780`
1. [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,528`
1. [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,504`
1. [golang/groupcache](https://github.com/golang/groupcache) — Distributed cache library ☆`13,300`
1. [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,133`
...
1. [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,707`
...
1. [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,575`
1. [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,369`
