...
![Total Stars](https://img.shields.io/badge/total%20stars-4,971,321-gold)
...
- [sashabaranov/go-openai](https://github.com/sashabaranov/go-openai) — OpenAI API client for Go ☆`10,502`
...
- [maximhq/bifrost](https://github.com/maximhq/bifrost) — Fastest LLM gateway for Go ☆`1,673`
...
- [asticode/go-astiav](https://github.com/asticode/go-astiav) — Golang ffmpeg and libav C bindings ☆`621`
...
- [bwmarrin/discordgo](https://github.com/bwmarrin/discordgo) — (Golang) Go bindings for Discord ☆`5,745`
...
- [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,511`
- [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,690`
...
- [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,736`
...
- [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,346`
- [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`61,043`
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`53,114`
...
- [fleetdm/fleet](https://github.com/fleetdm/fleet) — Open device management ☆`5,908`
- [taubyte/tau](https://github.com/taubyte/tau) — Fullstack Workspace for Humans & Machines ☆`4,871`
- [megaease/easeprobe](https://github.com/megaease/easeprobe) — Service health monitoring tool ☆`2,291`
...
- [pomerium/pomerium](https://github.com/pomerium/pomerium) — Pomerium is an identity and context-aware access proxy. ☆`4,633`
- [peak/s5cmd](https://github.com/peak/s5cmd) — Parallel S3 and local filesystem execution tool. ☆`3,840`
...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,816`
- [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,361`
- [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,869`
- [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,905`
- [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) — API traffic analyzer for Kubernetes ☆`11,675`
- [flannel-io/flannel](https://github.com/flannel-io/flannel) — Network fabric for containers ☆`9,371`
- [getanteon/anteon](https://github.com/getanteon/anteon) — eBPF Kubernetes monitoring tool ☆`8,537`
- [kubevela/kubevela](https://github.com/kubevela/kubevela) — The Modern Application Platform. ☆`7,663`
...
- [apecloud/kubeblocks](https://github.com/apecloud/kubeblocks) — Kubernetes operator for databases ☆`2,951`
...
- [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,632`
...
- [stripe/stripe-go](https://github.com/stripe/stripe-go) — Stripe API library for Go ☆`2,506`
...
- [mlange-42/ark](https://github.com/mlange-42/ark) — Ark -- Archetype-based Entity Component System (ECS) for Go. ☆`200`
...
- [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`69,147`
- [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,744`
- [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`55,192`
- [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,309`
- [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`11,583`
- [adnanh/webhook](https://github.com/adnanh/webhook) — Lightweight webhook server ☆`11,487`
- [roadrunner-server/roadrunner](https://github.com/roadrunner-server/roadrunner) — High-performance PHP application server ☆`8,372`
- [easegress-io/easegress](https://github.com/easegress-io/easegress) — A Cloud Native traffic orchestration system ☆`5,867`
- [flipt-io/flipt](https://github.com/flipt-io/flipt) — Enterprise-ready, Git native feature management solution ☆`4,681`
...
- [go-acme/lego](https://github.com/go-acme/lego) — Let's Encrypt/ACME client and library written in Go ☆`9,143`
...
- [sigstore/cosign](https://github.com/sigstore/cosign) — Code signing and transparency for containers and binaries ☆`5,566`
- [openziti/ziti](https://github.com/openziti/ziti) — Zero trust networking platform ☆`3,810`
- [spiffe/spire](https://github.com/spiffe/spire) — The SPIFFE Runtime Environment ☆`2,176`
...
- [brianvoe/gofakeit](https://github.com/brianvoe/gofakeit) — Random fake data generator written in go ☆`5,283`
- [uber-go/mock](https://github.com/uber-go/mock) — GoMock is a mocking framework for the Go programming language. ☆`3,225`
...
- [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,352`
...
- [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,637`
- [go-rod/rod](https://github.com/go-rod/rod) — Chrome DevTools driver for scraping ☆`6,548`
...
- [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,657`
- [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`15,202`
- [Shopify/toxiproxy](https://github.com/Shopify/toxiproxy) — TCP proxy for chaos testing ☆`11,773`
...
- [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,576`
- [gookit/validate](https://github.com/gookit/validate) — Struct and data validation ☆`1,123`
- [Oudwins/zog](https://github.com/Oudwins/zog) — Zod-inspired schema validation ☆`1,109`
...
- [dustin/go-humanize](https://github.com/dustin/go-humanize) — Human-friendly unit formatting ☆`4,771`
...
- [yuin/goldmark](https://github.com/yuin/goldmark) — Markdown parser for Go ☆`4,525`
- [JohannesKaufmann/html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) — Convert HTML to Markdown ☆`3,330`
- [pelletier/go-toml](https://github.com/pelletier/go-toml) — TOML library for Go ☆`1,895`
...
- [mvdan/sh](https://github.com/mvdan/sh) — Shell parser and formatter ☆`8,386`
...
- [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`25,001`
- [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,878`
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,469`
...
- [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,903`
- [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`53,111`
- [xo/usql](https://github.com/xo/usql) — Universal SQL CLI ☆`9,763`
- [minio/mc](https://github.com/minio/mc) — Unix utilities for object stores ☆`3,339`
- [joshmedeski/sesh](https://github.com/joshmedeski/sesh) — Terminal session manager ☆`1,574`
...
- [alajmo/mani](https://github.com/alajmo/mani) — CLI for managing repositories ☆`641`
...
- [duke-git/lancet](https://github.com/duke-git/lancet) — Comprehensive util library ☆`5,251`
...
- [failsafe-go/failsafe-go](https://github.com/failsafe-go/failsafe-go) — Fault tolerance patterns ☆`2,123`
...
- [abhimanyu003/sttr](https://github.com/abhimanyu003/sttr) — CLI string operations ☆`1,275`
...
- [google/uuid](https://github.com/google/uuid) — UUID generation and parsing ☆`5,950`
- [oklog/ulid](https://github.com/oklog/ulid) — ULID implementation ☆`4,965`
...
- [tdewolff/minify](https://github.com/tdewolff/minify) — Go minifiers for web formats ☆`4,048`
...
- [a-h/templ](https://github.com/a-h/templ) — A language for writing HTML user interfaces in Go. ☆`9,970`
...
- [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,685`
- [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,959`
- [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,390`
- [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`32,032`
- [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,374`
- [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`12,997`
- [cloudwego/hertz](https://github.com/cloudwego/hertz) — High-performance HTTP framework ☆`7,017`
...
- [goravel/goravel](https://github.com/goravel/goravel) — The full-featured Golang Development Framework skeleton ☆`4,384`
- [danielgtaylor/huma](https://github.com/danielgtaylor/huma) — Huma REST/HTTP API Framework for Golang with OpenAPI 3.1 ☆`3,729`
...
- [templui/templui](https://github.com/templui/templui) — UI components for Templ ☆`1,301`
- [savsgio/atreugo](https://github.com/savsgio/atreugo) — Micro web framework on fasthttp ☆`1,299`
- [ankorstore/yokai](https://github.com/ankorstore/yokai) — Modular framework for Go apps ☆`816`
...
- [fastschema/fastschema](https://github.com/fastschema/fastschema) — All-in-One Backend as a Service with Headless CMS Power ☆`531`
...
- [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,073`
...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) — Workflow engine with Web UI ☆`2,981`
...
1. [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,816`
1. [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,685`
1. [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,903`
1. [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,346`
1. [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`69,147`
...
1. [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`61,043`
1. [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,744`
1. [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`55,192`
1. [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,999`
1. [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`53,114`
1. [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`53,111`
1. [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,309`
...
1. [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,959`
...
1. [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`32,032`
1. [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,869`
1. [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,736`
1. [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,731`
1. [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,361`
...
1. [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,632`
1. [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,511`
...
1. [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,657`
...
1. [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`25,001`
...
1. [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,352`
...
1. [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,576`
...
1. [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,073`
...
1. [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,469`
...
1. [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,374`
1. [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`15,202`
1. [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,905`
1. [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,878`
...
1. [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,690`
1. [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,638`
1. [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,637`
...
1. [Shopify/toxiproxy](https://github.com/Shopify/toxiproxy) — TCP proxy for chaos testing ☆`11,773`
