...
![Total Stars](https://img.shields.io/badge/total%20stars-4,958,499-gold)
...
- [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`181,734`
- [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`49,266`
...
- [maximhq/bifrost](https://github.com/maximhq/bifrost) — Fastest LLM gateway for Go ☆`8,364`
...
- [asticode/go-astiav](https://github.com/asticode/go-astiav) — Golang ffmpeg and libav C bindings ☆`744`
- [asticode/go-astisub](https://github.com/asticode/go-astisub) — Manipulate subtitles in Go ☆`716`
...
- [golang/oauth2](https://github.com/golang/oauth2) — Go OAuth2 ☆`5,899`
...
- [apache/casbin](https://github.com/apache/casbin) — Authorization library for Go ☆`20,404`
- [openfga/openfga](https://github.com/openfga/openfga) — Fine-grained authorization server ☆`5,863`
...
- [go-telegram/bot](https://github.com/go-telegram/bot) — Telegram Bot API Go framework ☆`1,844`
...
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`45,125`
- [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,641`
- [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,590`
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) — Style definitions for nice terminal layouts ☆`11,870`
...
- [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) — TUI components for Bubble Tea ☆`8,945`
- [pterm/pterm](https://github.com/pterm/pterm) — Modern terminal output library ☆`5,542`
...
- [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`44,650`
...
- [asynkron/protoactor-go](https://github.com/asynkron/protoactor-go) — Ultra fast distributed actors for Go ☆`5,506`
...
- [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,511`
...
- [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`30,467`
- [caarlos0/env](https://github.com/caarlos0/env) — Parse environment variables to structs ☆`6,320`
- [knadh/koanf](https://github.com/knadh/koanf) — Lightweight config management ☆`4,210`
...
- [bits-and-blooms/bloom](https://github.com/bits-and-blooms/bloom) — Bloom filter implementation ☆`2,815`
...
- [deckarep/golang-set](https://github.com/deckarep/golang-set) — Generic set type for Go ☆`4,758`
...
- [maypok86/otter](https://github.com/maypok86/otter) — A high performance caching library for Go ☆`2,683`
...
- [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`18,940`
- [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`14,507`
- [pressly/goose](https://github.com/pressly/goose) — A database migration tool. Supports SQL migrations and Go functions. ☆`11,501`
- [ariga/atlas](https://github.com/ariga/atlas) — Declarative schema migrations with schema-as-code workflows ☆`8,748`
...
- [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`21,354`
- [sosedoff/pgweb](https://github.com/sosedoff/pgweb) — Cross-platform client for PostgreSQL databases ☆`9,514`
- [go-mysql-org/go-mysql](https://github.com/go-mysql-org/go-mysql) — a powerful mysql toolset with Go ☆`4,970`
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`66,228`
- [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`46,254`
- [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`40,589`
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`32,501`
...
- [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`24,514`
- [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,806`
- [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`17,769`
- [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,770`
- [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,773`
- [dicedb/dicedb](https://github.com/dicedb/dicedb) — Low-latency key/value engine on Valkey with storage tiers ☆`10,770`
- [etcd-io/bbolt](https://github.com/etcd-io/bbolt) — An embedded key/value database for Go. ☆`9,753`
- [codenotary/immudb](https://github.com/codenotary/immudb) — Immutable database with SQL ☆`9,037`
- [cockroachdb/pebble](https://github.com/cockroachdb/pebble) — RocksDB/LevelDB inspired key-value database in Go ☆`6,040`
...
- [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`34,983`
- [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`14,469`
...
- [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`22,251`
...
- [chenmingyong0423/go-mongox](https://github.com/chenmingyong0423/go-mongox) — MongoDB driver wrapper with generics ☆`223`
...
- [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,967`
- [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`17,204`
...
- [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`14,271`
...
- [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`18,324`
- [xo/dbtpl](https://github.com/xo/dbtpl) — Generate Go code for databases ☆`3,898`
- [go-jet/jet](https://github.com/go-jet/jet) — Type-safe SQL builder with codegen ☆`3,807`
...
- [sourcegraph/zoekt](https://github.com/sourcegraph/zoekt) — Fast trigram-based code search ☆`1,930`
- [sdqri/effdsl](https://github.com/sdqri/effdsl) — Elasticsearch query builder for golang ☆`35`
## DevOps & Build

### Backup

- [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`36,259`
- [gilbertchen/duplicacy](https://github.com/gilbertchen/duplicacy) — Cloud backup tool ☆`5,688`
### Build Automation

- [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`24,021`
- [go-task/task](https://github.com/go-task/task) — Fast cross-platform build tool inspired by Make ☆`16,194`
...
- [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`38,438`
- [woodpecker-ci/woodpecker](https://github.com/woodpecker-ci/woodpecker) — Simple, powerful CI/CD engine ☆`7,911`
...
- [pipe-cd/pipecd](https://github.com/pipe-cd/pipecd) — The One CD for All {applications, platforms, operations} ☆`1,358`
...
- [ko-build/ko](https://github.com/ko-build/ko) — Build and deploy Go applications ☆`8,549`
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`58,156`
- [TwiN/gatus](https://github.com/TwiN/gatus) — Developer-oriented status page with alerting ☆`12,161`
- [fleetdm/fleet](https://github.com/fleetdm/fleet) — Open device management ☆`6,913`
...
- [gabrie30/ghorg](https://github.com/gabrie30/ghorg) — Clone entire GitHub orgs ☆`2,153`
...
- [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,799`
- [pomerium/pomerium](https://github.com/pomerium/pomerium) — Pomerium is an identity and context-aware access proxy. ☆`5,016`
- [peak/s5cmd](https://github.com/peak/s5cmd) — Parallel S3 and local filesystem execution tool. ☆`4,201`
...
- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`127,997`
- [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`34,039`
- [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`32,155`
- [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`15,509`
...
- [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`31,587`
...
- [axllent/mailpit](https://github.com/axllent/mailpit) — An email and SMTP testing tool with API for developers ☆`10,453`
- [foxcpp/maddy](https://github.com/foxcpp/maddy) — Composable all-in-one mail server. ☆`6,091`
- [mjl-/mox](https://github.com/mjl-/mox) — Modern secure mail server ☆`5,872`
- [matcornic/hermes](https://github.com/matcornic/hermes) — Clean HTML email generator ☆`3,032`
- [AfterShip/email-verifier](https://github.com/AfterShip/email-verifier) — Email verification without sending emails ☆`1,625`
...
- [gnolang/gno](https://github.com/gnolang/gno) — Interpreted Go virtual machine ☆`1,086`
- [cometbft/cometbft](https://github.com/cometbft/cometbft) — Byzantine fault-tolerant consensus ☆`921`
- [ChainSafe/gossamer](https://github.com/ChainSafe/gossamer) — Go Implementation of the Polkadot Host ☆`454`
### Financial

- [shopspring/decimal](https://github.com/shopspring/decimal) — Arbitrary-precision fixed-point decimal numbers in Go ☆`7,485`
- [achannarasappa/ticker](https://github.com/achannarasappa/ticker) — Terminal stock and crypto tracker ☆`6,240`
...
- [formancehq/ledger](https://github.com/formancehq/ledger) — The programmable open source core ledger for fintech ☆`1,403`
...
- [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`28,708`
- [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`14,249`
- [go-vgo/robotgo](https://github.com/go-vgo/robotgo) — Cross-platform RPA and GUI automation ☆`10,830`
...
- [richardwilkes/unison](https://github.com/richardwilkes/unison) — Unified GUI toolkit for Go ☆`339`
### Windows
...
- [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`13,508`
...
- [go-gl/gl](https://github.com/go-gl/gl) — Go bindings for OpenGL (generated via glow) ☆`1,207`
- [go-gl/mathgl](https://github.com/go-gl/mathgl) — A pure Go 3D math library. ☆`609`
## Geospatial

- [tidwall/tile38](https://github.com/tidwall/tile38) — Real-time Geospatial and Geofencing ☆`9,735`
...
- [ondrajz/go-callvis](https://github.com/ondrajz/go-callvis) — Visualize call graph of a Go program using Graphviz ☆`6,525`
...
- [hybridgroup/gobot](https://github.com/hybridgroup/gobot) — Robotics and IoT framework ☆`9,475`
...
- [miekg/dns](https://github.com/miekg/dns) — DNS library in Go ☆`8,773`
...
- [luraproject/lura](https://github.com/luraproject/lura) — Ultra-performant API gateway ☆`6,800`
...
- [temporalio/sdk-go](https://github.com/temporalio/sdk-go) — Temporal Go SDK ☆`975`
...
- [imroc/req](https://github.com/imroc/req) — Simple Go HTTP client with Black Magic ☆`4,866`
...
- [bogdanfinn/tls-client](https://github.com/bogdanfinn/tls-client) — HTTP client with TLS fingerprint spoofing ☆`1,859`
...
- [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`76,082`
- [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`61,154`
- [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`52,310`
- [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`12,577`
- [adnanh/webhook](https://github.com/adnanh/webhook) — Lightweight webhook server ☆`12,153`
...
- [getfider/fider](https://github.com/getfider/fider) — Open platform to collect and prioritize feedback ☆`4,542`
- [xyproto/algernon](https://github.com/xyproto/algernon) — Web server with Lua and Markdown ☆`3,029`
- [openflagr/flagr](https://github.com/openflagr/flagr) — Feature flagging and A/B testing ☆`2,608`
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) — Open source feature flag solution ☆`2,117`
...
- [hashicorp/go-getter](https://github.com/hashicorp/go-getter) — Download files from URLs ☆`1,826`
...
- [gaissmai/bart](https://github.com/gaissmai/bart) — Balanced routing table ☆`161`
...
- [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`16,800`
- [quic-go/quic-go](https://github.com/quic-go/quic-go) — A production-ready QUIC implementation in pure Go ☆`11,783`
...
- [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`23,074`
...
- [panjf2000/gnet](https://github.com/panjf2000/gnet) — High-performance event-loop network ☆`11,250`
- [cloudwego/netpoll](https://github.com/cloudwego/netpoll) — High-performance I/O framework ☆`4,606`
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`15,915`
...
- [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`20,772`
...
- [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`13,738`
- [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,519`
- [centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) — Scalable real-time messaging server ☆`10,798`
...
- [php/frankenphp](https://github.com/php/frankenphp) — The modern PHP app server ☆`11,364`
...
- [Shopify/go-lua](https://github.com/Shopify/go-lua) — Lua VM in Go ☆`3,456`
- [cel-expr/cel-go](https://github.com/cel-expr/cel-go) — Common Expression Language for Go ☆`3,110`
- [google/starlark-go](https://github.com/google/starlark-go) — Starlark config language in Go ☆`2,775`
...
- [oapi-codegen/oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) — Generate Go code from OpenAPI 3 specs ☆`8,593`
...
- [go-acme/lego](https://github.com/go-acme/lego) — Let's Encrypt/ACME client and library written in Go ☆`9,889`
...
- [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`23,712`
- [authzed/spicedb](https://github.com/authzed/spicedb) — Zanzibar-inspired permissions DB ☆`7,093`
...
- [Ullaakut/cameradar](https://github.com/Ullaakut/cameradar) — Cameradar hacks its way into RTSP videosurveillance cameras ☆`5,225`
- [corazawaf/coraza](https://github.com/corazawaf/coraza) — ModSecurity-compatible WAF in Go ☆`3,844`
...
- [sigstore/cosign](https://github.com/sigstore/cosign) — Code signing and transparency for containers and binaries ☆`6,327`
- [openziti/ziti](https://github.com/openziti/ziti) — Zero trust networking platform ☆`4,406`
- [spiffe/spire](https://github.com/spiffe/spire) — The SPIFFE Runtime Environment ☆`2,557`
...
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`19,400`
- [boyter/scc](https://github.com/boyter/scc) — Fast code counter and stats ☆`8,777`
...
- [daveshanley/vacuum](https://github.com/daveshanley/vacuum) — Fast OpenAPI linter ☆`1,130`
...
- [shurcooL/gostatus](https://github.com/shurcooL/gostatus) — Show status of Go repositories ☆`246`
...
- [vektra/mockery](https://github.com/vektra/mockery) — Mock code autogenerator for Go ☆`7,163`
...
- [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`23,241`
- [pixie-io/pixie](https://github.com/pixie-io/pixie) — Kubernetes-native observability ☆`6,540`
...
- [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`13,286`
- [go-rod/rod](https://github.com/go-rod/rod) — Chrome DevTools driver for scraping ☆`7,112`
- [sensepost/gowitness](https://github.com/sensepost/gowitness) — Web screenshot utility with Chrome ☆`4,521`
- [mxschmitt/playwright-go](https://github.com/mxschmitt/playwright-go) — Browser automation for Chromium, Firefox, WebKit ☆`3,511`
- [mafredri/cdp](https://github.com/mafredri/cdp) — Chrome DevTools Protocol bindings ☆`797`
### Testing Frameworks

- [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`26,215`
- [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`18,475`
...
- [dustin/go-humanize](https://github.com/dustin/go-humanize) — Human-friendly unit formatting ☆`4,830`
...
- [yuin/goldmark](https://github.com/yuin/goldmark) — Markdown parser for Go ☆`5,036`
- [JohannesKaufmann/html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) — Convert HTML to Markdown ☆`3,823`
...
- [mvdan/sh](https://github.com/mvdan/sh) — Shell parser and formatter ☆`9,087`
...
- [blevesearch/bleve](https://github.com/blevesearch/bleve) — Text/numeric/geo/vector indexing library ☆`11,231`
...
- [aws/aws-sdk-go-v2](https://github.com/aws/aws-sdk-go-v2) — AWS SDK for the Go programming language. ☆`3,658`
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`16,068`
...
- [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`83,250`
- [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`54,607`
- [xo/usql](https://github.com/xo/usql) — Universal SQL CLI ☆`10,126`
...
- [owenthereal/upterm](https://github.com/owenthereal/upterm) — Instant terminal sharing ☆`1,302`
...
- [hashicorp/go-multierror](https://github.com/hashicorp/go-multierror) — Represent multiple errors as one ☆`2,589`
- [cockroachdb/errors](https://github.com/cockroachdb/errors) — Error library with portability ☆`2,474`
...
- [ztrue/tracerr](https://github.com/ztrue/tracerr) — Errors with stack trace ☆`1,123`
...
- [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`40,445`
- [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,938`
- [pdfcpu/pdfcpu](https://github.com/pdfcpu/pdfcpu) — PDF processor in Go ☆`8,853`
- [spf13/afero](https://github.com/spf13/afero) — Filesystem abstraction for Go ☆`6,705`
- [dundee/gdu](https://github.com/dundee/gdu) — Fast disk usage analyzer ☆`6,015`
...
- [go-playground/form](https://github.com/go-playground/form) — URL values to structs ☆`931`
...
- [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,754`
- [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,658`
...
- [Lifailon/lazyjournal](https://github.com/Lifailon/lazyjournal) — TUI for journald, Docker, K8s logs ☆`1,413`
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`56,636`
...
- [abhimanyu003/sttr](https://github.com/abhimanyu003/sttr) — CLI string operations ☆`1,351`
...
- [cilium/ebpf](https://github.com/cilium/ebpf) — eBPF library for Go ☆`7,970`
...
- [anchore/syft](https://github.com/anchore/syft) — SBOM generator for containers ☆`9,611`
...
- [go-git/go-git](https://github.com/go-git/go-git) — Pure Go Git implementation ☆`7,775`
...
- [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`33,357`
- [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,946`
...
- [trpc-group/trpc-go](https://github.com/trpc-group/trpc-go) — A pluggable, high-performance RPC framework written in golang ☆`1,204`
...
- [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`22,891`
...
- [a-h/templ](https://github.com/a-h/templ) — A language for writing HTML user interfaces in Go. ☆`10,556`
...
- [go-sprout/sprout](https://github.com/go-sprout/sprout) — Template functions for Go ☆`231`
- [goradd/got](https://github.com/goradd/got) — Template engine with Go code output ☆`39`
### Web Frameworks

- [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`89,259`
- [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`40,183`
...
- [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`20,894`
- [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`13,282`
- [cloudwego/hertz](https://github.com/cloudwego/hertz) — High-performance HTTP framework ☆`7,375`
- [goadesign/goa](https://github.com/goadesign/goa) — Design-first API framework ☆`6,109`
...
- [danielgtaylor/huma](https://github.com/danielgtaylor/huma) — Huma REST/HTTP API Framework for Golang with OpenAPI 3.1 ☆`4,423`
...
- [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,786`
...
- [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) — Background tasks, AI agents, and durable workflows ☆`8,007`
- [go-co-op/gocron](https://github.com/go-co-op/gocron) — Easy and fluent Go cron scheduling ☆`7,170`
...
- [redpanda-data/connect](https://github.com/redpanda-data/connect) — Fancy stream processing made operationally mundane ☆`8,767`
- [dagucloud/dagu](https://github.com/dagucloud/dagu) — Workflow engine with Web UI ☆`4,090`
...
1. [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`181,734`
1. [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`127,997`
1. [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`89,259`
1. [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`83,250`
1. [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`76,082`
1. [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`72,132`
1. [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`66,228`
1. [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`64,969`
1. [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`61,154`
1. [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`58,156`
1. [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`56,636`
1. [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`54,607`
1. [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`52,310`
1. [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`51,371`
1. [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`49,266`
1. [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`46,254`
1. [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`45,125`
1. [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`44,650`
1. [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`40,589`
1. [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`40,445`
1. [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`40,183`
1. [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,967`
1. [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`38,438`
1. [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`36,259`
1. [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`34,983`
1. [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`34,039`
1. [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`33,357`
1. [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`32,728`
1. [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`32,501`
1. [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,429`
1. [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`32,155`
...
1. [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`31,587`
1. [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`30,467`
1. [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`28,708`
1. [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`26,215`
1. [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,946`
1. [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,754`
...
1. [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,658`
1. [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`24,514`
...
1. [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`23,712`
1. [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,475`
1. [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`23,241`
1. [micro/go-micro](https://github.com/micro/go-micro) — A Go agent harness and service framework ☆`23,078`
1. [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`23,074`
1. [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`22,891`
1. [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`22,251`
...
1. [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`21,354`
1. [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,938`
1. [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`20,894`
1. [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`20,772`
1. [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,641`
1. [apache/casbin](https://github.com/apache/casbin) — Authorization library for Go ☆`20,404`
1. [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`20,178`
1. [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`19,400`
1. [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`18,940`
1. [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`18,475`
1. [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`18,324`
1. [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,786`
1. [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,770`
1. [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`17,769`
1. [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`17,204`
1. [ipfs/kubo](https://github.com/ipfs/kubo) — IPFS daemon with CLI, HTTP gateway, and RPC ☆`17,143`
1. [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`16,800`
1. [fatih/vim-go](https://github.com/fatih/vim-go) — Go development plugin for Vim ☆`16,218`
1. [go-task/task](https://github.com/go-task/task) — Fast cross-platform build tool inspired by Make ☆`16,194`
1. [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`16,068`
1. [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`15,915`
1. [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,799`
1. [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,773`
1. [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,559`
1. [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`15,509`
...
1. [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,511`
1. [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`14,507`
1. [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`14,469`
1. [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`14,271`
1. [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`14,249`
1. [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`13,738`
1. [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,590`
1. [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`13,508`
1. [golang/groupcache](https://github.com/golang/groupcache) — Distributed cache library ☆`13,337`
1. [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`13,286`
1. [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`13,282`
...
1. [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`12,577`
...
1. [TwiN/gatus](https://github.com/TwiN/gatus) — Developer-oriented status page with alerting ☆`12,161`
1. [adnanh/webhook](https://github.com/adnanh/webhook) — Lightweight webhook server ☆`12,153`
