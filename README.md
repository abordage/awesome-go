...
![Total Stars](https://img.shields.io/badge/total%20stars-4,950,509-gold)
...
- [sashabaranov/go-openai](https://github.com/sashabaranov/go-openai) — OpenAI API client for Go ☆`10,475`
...
- [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`158,322`
- [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`40,776`
- [tmc/langchaingo](https://github.com/tmc/langchaingo) — LangChain for Go, the easiest way to write LLM-based programs in Go ☆`8,318`
- [maximhq/bifrost](https://github.com/maximhq/bifrost) — Fastest LLM gateway for Go ☆`1,432`
...
- [otiai10/gosseract](https://github.com/otiai10/gosseract) — OCR using Tesseract in Go ☆`3,037`
- [galeone/tfgo](https://github.com/galeone/tfgo) — Tensorflow + Go, the gopher way ☆`2,491`
- [gomlx/gomlx](https://github.com/gomlx/gomlx) — GoMLX: An Accelerated Machine Learning Framework For Go ☆`1,261`
...
- [hybridgroup/gocv](https://github.com/hybridgroup/gocv) — Computer vision with OpenCV 4 ☆`7,324`
...
- [yeqown/go-qrcode](https://github.com/yeqown/go-qrcode) — Customizable QR code generator ☆`795`
...
- [golang-jwt/jwt](https://github.com/golang-jwt/jwt) — Go implementation of JSON Web Tokens (JWT). ☆`8,799`
- [markbates/goth](https://github.com/markbates/goth) — Multi-provider authentication ☆`6,386`
- [golang/oauth2](https://github.com/golang/oauth2) — Go OAuth2 ☆`5,787`
- [aarondl/authboss](https://github.com/aarondl/authboss) — The boss of http auth. ☆`4,131`
...
- [shaj13/go-guardian](https://github.com/shaj13/go-guardian) — Authentication library for Go ☆`602`
...
- [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,596`
...
- [tucnak/telebot](https://github.com/tucnak/telebot) — Telebot is a Telegram bot framework in Go. ☆`4,514`
- [go-telegram/bot](https://github.com/go-telegram/bot) — Telegram Bot API Go framework ☆`1,503`
...
- [bwmarrin/discordgo](https://github.com/bwmarrin/discordgo) — (Golang) Go bindings for Discord ☆`5,717`
...
- [go-lark/lark](https://github.com/go-lark/lark) — Feishu/Lark SDK for Go ☆`233`
- [switchupcb/disgo](https://github.com/switchupcb/disgo) — Next-gen Discord API library ☆`109`
## CLI & Terminal

### Advanced Console UIs

- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`37,727`
- [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,119`
- [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,496`
...
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) — Style definitions for nice terminal layouts ☆`10,207`
- [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) — TUI components for Bubble Tea ☆`7,431`
...
- [schollz/progressbar](https://github.com/schollz/progressbar) — Thread-safe progress bar ☆`4,620`
- [mum4k/termdash](https://github.com/mum4k/termdash) — Terminal-based dashboard ☆`2,956`
- [guptarohit/asciigraph](https://github.com/guptarohit/asciigraph) — ASCII line graphs in terminal ☆`2,935`
...
- [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,728`
- [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,780`
- [elves/elvish](https://github.com/elves/elvish) — Scripting shell for Go ☆`6,196`
...
- [carapace-sh/carapace](https://github.com/carapace-sh/carapace) — Multi-shell completion library ☆`1,053`
...
- [ergo-services/ergo](https://github.com/ergo-services/ergo) — Actor framework with network transparency ☆`4,319`
- [anthdm/hollywood](https://github.com/anthdm/hollywood) — Blazingly fast and light-weight Actor engine written in Golang ☆`2,151`
- [Tochemey/goakt](https://github.com/Tochemey/goakt) — Distributed actor framework ☆`306`
### Goroutines

- [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,215`
- [benmanns/goworker](https://github.com/benmanns/goworker) — Resque-compatible background worker ☆`2,847`
- [alitto/pond](https://github.com/alitto/pond) — High-performance worker pool ☆`2,051`
...
- [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,741`
- [caarlos0/env](https://github.com/caarlos0/env) — Parse environment variables to structs ☆`5,905`
- [knadh/koanf](https://github.com/knadh/koanf) — Lightweight config management ☆`3,703`
...
- [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,377`
- [bytedance/sonic](https://github.com/bytedance/sonic) — A blazingly fast JSON serializing & deserializing library ☆`8,985`
- [Jeffail/gabs](https://github.com/Jeffail/gabs) — Dynamic JSON parsing ☆`3,526`
- [valyala/fastjson](https://github.com/valyala/fastjson) — Fast JSON parser for Go ☆`2,419`
...
- [golang/protobuf](https://github.com/golang/protobuf) — Protocol buffers for Go ☆`10,053`
...
- [fxamacker/cbor](https://github.com/fxamacker/cbor) — CBOR codec with extensions ☆`993`
...
- [bits-and-blooms/bloom](https://github.com/bits-and-blooms/bloom) — Bloom filter implementation ☆`2,720`
...
- [Workiva/go-datastructures](https://github.com/Workiva/go-datastructures) — Performant, threadsafe data structures ☆`7,880`
- [deckarep/golang-set](https://github.com/deckarep/golang-set) — Generic set type for Go ☆`4,633`
- [bits-and-blooms/bitset](https://github.com/bits-and-blooms/bitset) — Go package implementing bitsets ☆`1,472`
...
- [eko/gocache](https://github.com/eko/gocache) — Multi-store caching library ☆`2,818`
- [bluele/gcache](https://github.com/bluele/gcache) — In-memory cache with eviction ☆`2,725`
- [maypok86/otter](https://github.com/maypok86/otter) — A high performance caching library for Go ☆`2,460`
...
- [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,851`
- [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,485`
- [pressly/goose](https://github.com/pressly/goose) — A database migration tool. Supports SQL migrations and Go functions. ☆`9,731`
- [ariga/atlas](https://github.com/ariga/atlas) — Manage your database schema as code ☆`7,801`
- [amacneil/dbmate](https://github.com/amacneil/dbmate) — A lightweight, framework-agnostic database migration tool. ☆`6,586`
...
- [cybertec-postgresql/pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) — Advanced PostgreSQL scheduler ☆`1,296`
- [liweiyi88/onedump](https://github.com/liweiyi88/onedump) — Effortless database administration tool ☆`785`
- [HDT3213/rdb](https://github.com/HDT3213/rdb) — Redis RDB parser for Go ☆`591`
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`61,921`
- [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`41,938`
- [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,517`
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,654`
- [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,020`
- [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,426`
- [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,492`
- [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,181`
- [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,811`
- [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,307`
- [etcd-io/bbolt](https://github.com/etcd-io/bbolt) — An embedded key/value database for Go. ☆`9,276`
...
- [nalgeon/redka](https://github.com/nalgeon/redka) — Redis re-implemented with SQL ☆`4,425`
- [HDT3213/godis](https://github.com/HDT3213/godis) — A Golang implemented Redis Server and Cluster ☆`3,808`
...
- [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,116`
- [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,583`
...
- [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,766`
...
- [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,306`
...
- [uptrace/bun](https://github.com/uptrace/bun) — SQL-first Golang ORM ☆`4,551`
- [upper/db](https://github.com/upper/db) — Data access layer for databases ☆`3,630`
...
- [TomWright/dasel](https://github.com/TomWright/dasel) — Query and modify data formats ☆`7,754`
...
- [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,078`
- [denisenkom/go-mssqldb](https://github.com/denisenkom/go-mssqldb) — Microsoft SQL server driver written in go language ☆`1,878`
- [ncruces/go-sqlite3](https://github.com/ncruces/go-sqlite3) — Go bindings to SQLite using wazero ☆`882`
...
- [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,589`
- [Masterminds/squirrel](https://github.com/Masterminds/squirrel) — Fluent SQL generation for golang ☆`7,826`
- [xo/dbtpl](https://github.com/xo/dbtpl) — Generate Go code for databases ☆`3,876`
- [go-jet/jet](https://github.com/go-jet/jet) — Type-safe SQL builder with codegen ☆`3,505`
...
- [sourcegraph/zoekt](https://github.com/sourcegraph/zoekt) — Fast trigram-based code search ☆`1,313`
- [sdqri/effdsl](https://github.com/sdqri/effdsl) — Elasticsearch query builder for golang ☆`34`
## DevOps & Build

### Backup

- [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,412`
- [gilbertchen/duplicacy](https://github.com/gilbertchen/duplicacy) — Cloud backup tool ☆`5,595`
### Build Automation

- [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,551`
- [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,491`
...
- [woodpecker-ci/woodpecker](https://github.com/woodpecker-ci/woodpecker) — Simple, powerful CI/CD engine ☆`6,125`
...
- [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,275`
- [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`60,737`
- [ko-build/ko](https://github.com/ko-build/ko) — Build and deploy Go applications ☆`8,276`
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`52,730`
- [moovweb/gvm](https://github.com/moovweb/gvm) — Go Version Manager ☆`11,456`
- [TwiN/gatus](https://github.com/TwiN/gatus) — The most advanced status page in the world ☆`9,386`
- [bitfield/script](https://github.com/bitfield/script) — Making it easy to write shell-like scripts in Go ☆`6,905`
- [fleetdm/fleet](https://github.com/fleetdm/fleet) — Open device management ☆`5,864`
...
- [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,539`
- [pomerium/pomerium](https://github.com/pomerium/pomerium) — Pomerium is an identity and context-aware access proxy. ☆`4,555`
- [peak/s5cmd](https://github.com/peak/s5cmd) — Parallel S3 and local filesystem execution tool. ☆`3,811`
- [aptly-dev/aptly](https://github.com/aptly-dev/aptly) — aptly - Debian repository management tool ☆`2,742`
- [KusionStack/kusion](https://github.com/KusionStack/kusion) — Declarative platform orchestrator ☆`1,237`
- [oxyno-zeta/s3-proxy](https://github.com/oxyno-zeta/s3-proxy) — S3 reverse proxy with auth ☆`425`
### Kubernetes

- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,454`
- [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,303`
- [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,733`
- [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,849`
- [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) — API traffic analyzer for Kubernetes ☆`11,605`
- [flannel-io/flannel](https://github.com/flannel-io/flannel) — Network fabric for containers ☆`9,360`
...
- [k3d-io/k3d](https://github.com/k3d-io/k3d) — Little helper to run CNCF's k3s in Docker ☆`6,180`
...
- [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,528`
- [tsenart/vegeta](https://github.com/tsenart/vegeta) — HTTP load testing tool and library. It's over 9000! ☆`24,805`
- [codesenberg/bombardier](https://github.com/codesenberg/bombardier) — Fast cross-platform HTTP benchmarking tool written in Go ☆`6,674`
...
- [axllent/mailpit](https://github.com/axllent/mailpit) — An email and SMTP testing tool with API for developers ☆`8,346`
- [foxcpp/maddy](https://github.com/foxcpp/maddy) — Composable all-in-one mail server. ☆`5,775`
- [mjl-/mox](https://github.com/mjl-/mox) — Modern secure mail server ☆`5,325`
...
- [wneessen/go-mail](https://github.com/wneessen/go-mail) — Easy to use, yet comprehensive library for sending mails with Go ☆`1,224`
...
- [vanng822/go-premailer](https://github.com/vanng822/go-premailer) — Inline CSS for HTML mail ☆`181`
...
- [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,566`
- [ipfs/kubo](https://github.com/ipfs/kubo) — An IPFS implementation in Go ☆`16,853`
- [lightningnetwork/lnd](https://github.com/lightningnetwork/lnd) — Lightning Network Daemon ☆`8,074`
- [cosmos/cosmos-sdk](https://github.com/cosmos/cosmos-sdk) — A Framework for Building High Value Public Blockchains ☆`6,876`
...
- [shopspring/decimal](https://github.com/shopspring/decimal) — Arbitrary-precision fixed-point decimal numbers in Go ☆`7,159`
...
- [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,686`
- [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,746`
- [therecipe/qt](https://github.com/therecipe/qt) — Qt bindings for Go ☆`10,772`
- [go-vgo/robotgo](https://github.com/go-vgo/robotgo) — Cross-platform RPA and GUI automation ☆`10,550`
...
- [ncruces/zenity](https://github.com/ncruces/zenity) — Zenity dialogs for Golang, Windows, macOS ☆`877`
...
- [richardwilkes/unison](https://github.com/richardwilkes/unison) — Unified GUI toolkit for Go ☆`308`
### Windows
...
- [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`12,795`
...
- [mlange-42/ark](https://github.com/mlange-42/ark) — Ark -- Archetype-based Entity Component System (ECS) for Go. ☆`194`
...
- [tidwall/tile38](https://github.com/tidwall/tile38) — Real-time Geospatial and Geofencing ☆`9,546`
...
- [visualfc/liteide](https://github.com/visualfc/liteide) — LiteIDE is a simple, open source, cross-platform Go IDE. ☆`7,735`
...
- [Zxilly/go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) — Analyze compiled Go binary size ☆`1,864`
...
- [safedep/vet](https://github.com/safedep/vet) — Protect against malicious open source packages ☆`921`
...
- [Edgenesis/shifu](https://github.com/Edgenesis/shifu) — Kubernetes-native IoT gateway ☆`1,391`
- [rulego/rulego](https://github.com/rulego/rulego) — Lightweight rule engine framework ☆`1,384`
...
- [etcd-io/raft](https://github.com/etcd-io/raft) — Raft library for maintaining a replicated state machine ☆`965`
...
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) — DNS ad-blocker for local networks ☆`5,839`
...
- [luraproject/lura](https://github.com/luraproject/lura) — Ultra-performant API gateway ☆`6,707`
...
- [k8gb-io/k8gb](https://github.com/k8gb-io/k8gb) — A cloud native Kubernetes Global Balancer ☆`1,132`
...
- [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,165`
...
- [imroc/req](https://github.com/imroc/req) — Simple Go HTTP client with Black Magic ☆`4,716`
...
- [bogdanfinn/tls-client](https://github.com/bogdanfinn/tls-client) — HTTP client with TLS fingerprint spoofing ☆`1,380`
...
- [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`68,773`
- [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,443`
- [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`54,628`
- [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,171`
- [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`11,512`
- [adnanh/webhook](https://github.com/adnanh/webhook) — Lightweight webhook server ☆`11,445`
...
- [charmbracelet/wish](https://github.com/charmbracelet/wish) — Make SSH apps, just like that! ☆`4,666`
- [getfider/fider](https://github.com/getfider/fider) — Open platform to collect and prioritize feedback ☆`3,930`
...
- [msoap/shell2http](https://github.com/msoap/shell2http) — Executing shell commands via HTTP server ☆`1,464`
- [openrundev/openrun](https://github.com/openrundev/openrun) — Open source Cloud Run alternative ☆`713`
- [webhookx-io/webhookx](https://github.com/webhookx-io/webhookx) — The Next-Generation Webhooks Gateway. ☆`268`
...
- [gaissmai/bart](https://github.com/gaissmai/bart) — Balanced routing table ☆`110`
...
- [dragonflyoss/dragonfly](https://github.com/dragonflyoss/dragonfly) — P2P-based container image distribution ☆`2,945`
...
- [lxzan/gws](https://github.com/lxzan/gws) — Fast websocket server and client ☆`1,683`
...
- [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,680`
...
- [panjf2000/gnet](https://github.com/panjf2000/gnet) — High-performance event-loop network ☆`10,994`
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,469`
- [xjasonlyu/tun2socks](https://github.com/xjasonlyu/tun2socks) — TUN to SOCKS proxy ☆`4,759`
...
- [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,864`
...
- [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,660`
- [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,357`
- [centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) — Scalable real-time messaging server ☆`9,671`
- [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) — Building event-driven applications the easy way in Go. ☆`9,350`
- [appleboy/gorush](https://github.com/appleboy/gorush) — A push notification server written in Go (Golang). ☆`8,658`
- [RichardKnop/machinery](https://github.com/RichardKnop/machinery) — Async task queue with message passing ☆`7,915`
- [nats-io/nats.go](https://github.com/nats-io/nats.go) — Golang client for NATS, the cloud native messaging system. ☆`6,322`
- [confluentinc/confluent-kafka-go](https://github.com/confluentinc/confluent-kafka-go) — Confluent's Apache Kafka Golang client ☆`5,073`
- [dunglas/mercure](https://github.com/dunglas/mercure) — Server-Sent Events hub ☆`5,143`
- [olahol/melody](https://github.com/olahol/melody) — Minimalist websocket framework for Go ☆`4,037`
...
- [containrrr/shoutrrr](https://github.com/containrrr/shoutrrr) — Notification library for gophers and their furry friends. ☆`1,437`
...
- [gonum/gonum](https://github.com/gonum/gonum) — Numeric libraries for Go ☆`8,272`
- [gonum/plot](https://github.com/gonum/plot) — Plotting and visualization ☆`2,933`
...
- [php/frankenphp](https://github.com/php/frankenphp) — The modern PHP app server ☆`10,584`
- [expr-lang/expr](https://github.com/expr-lang/expr) — Expression evaluation for Go ☆`7,556`
...
- [google/starlark-go](https://github.com/google/starlark-go) — Starlark config language in Go ☆`2,592`
...
- [oapi-codegen/oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) — Generate Go code from OpenAPI 3 specs ☆`7,923`
...
- [abice/go-enum](https://github.com/abice/go-enum) — Enum generator for Go ☆`908`
...
- [go-acme/lego](https://github.com/go-acme/lego) — Let's Encrypt/ACME client and library written in Go ☆`9,100`
...
- [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,483`
- [authzed/spicedb](https://github.com/authzed/spicedb) — Zanzibar-inspired permissions DB ☆`6,304`
...
- [corazawaf/coraza](https://github.com/corazawaf/coraza) — ModSecurity-compatible WAF in Go ☆`3,170`
...
- [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) — AI-powered honeypot framework ☆`1,775`
...
- [sigstore/cosign](https://github.com/sigstore/cosign) — Code signing and transparency for containers and binaries ☆`5,521`
- [openziti/ziti](https://github.com/openziti/ziti) — Zero trust networking platform ☆`3,774`
- [spiffe/spire](https://github.com/spiffe/spire) — The SPIFFE Runtime Environment ☆`2,160`
...
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`18,207`
- [boyter/scc](https://github.com/boyter/scc) — Fast code counter and stats ☆`7,899`
- [mgechev/revive](https://github.com/mgechev/revive) — Fast, extensible Go linter ☆`5,366`
...
- [vektra/mockery](https://github.com/vektra/mockery) — Mock code autogenerator for Go ☆`6,923`
- [DATA-DOG/go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) — SQL mock driver for testing ☆`6,498`
- [brianvoe/gofakeit](https://github.com/brianvoe/gofakeit) — Random fake data generator written in go ☆`5,269`
...
- [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,271`
- [pixie-io/pixie](https://github.com/pixie-io/pixie) — Kubernetes-native observability ☆`6,296`
...
- [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,597`
- [go-rod/rod](https://github.com/go-rod/rod) — Chrome DevTools driver for scraping ☆`6,514`
- [sensepost/gowitness](https://github.com/sensepost/gowitness) — Web screenshot utility with Chrome ☆`4,098`
- [playwright-community/playwright-go](https://github.com/playwright-community/playwright-go) — Browser automation for Chromium, Firefox, WebKit ☆`3,083`
- [mafredri/cdp](https://github.com/mafredri/cdp) — Chrome DevTools Protocol bindings ☆`770`
### Testing Frameworks
...
- [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,506`
...
- [yuin/goldmark](https://github.com/yuin/goldmark) — Markdown parser for Go ☆`4,471`
- [JohannesKaufmann/html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) — Convert HTML to Markdown ☆`3,289`
- [pelletier/go-toml](https://github.com/pelletier/go-toml) — TOML library for Go ☆`1,890`
- [antchfx/htmlquery](https://github.com/antchfx/htmlquery) — XPath for HTML queries ☆`775`
...
- [microcosm-cc/bluemonday](https://github.com/microcosm-cc/bluemonday) — Fast HTML sanitizer for Go ☆`3,586`
...
- [arunsupe/semantic-grep](https://github.com/arunsupe/semantic-grep) — Grep for similar words ☆`1,194`
...
- [mvdan/sh](https://github.com/mvdan/sh) — Shell parser and formatter ☆`8,338`
- [mmcdole/gofeed](https://github.com/mmcdole/gofeed) — Parse RSS, Atom, JSON feeds ☆`2,788`
...
- [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`24,946`
- [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,853`
...
- [blevesearch/bleve](https://github.com/blevesearch/bleve) — Text/numeric/geo/vector indexing library ☆`10,859`
...
- [go-ego/gse](https://github.com/go-ego/gse) — Multilingual text segmentation ☆`2,765`
...
- [googleapis/google-api-go-client](https://github.com/googleapis/google-api-go-client) — Auto-generated Google APIs for Go. ☆`4,363`
- [aws/aws-sdk-go-v2](https://github.com/aws/aws-sdk-go-v2) — AWS SDK for the Go programming language. ☆`3,398`
- [minio/minio-go](https://github.com/minio/minio-go) — High-performance object storage ☆`2,880`
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,402`
...
- [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,259`
- [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`52,974`
...
- [samber/lo](https://github.com/samber/lo) — Lodash-style utilities for Go ☆`20,793`
...
- [goforj/godump](https://github.com/goforj/godump) — Pretty-printer for Go structs ☆`1,517`
...
- [jmoiron/sqlx](https://github.com/jmoiron/sqlx) — Extensions for database/sql ☆`17,432`
...
- [uber-go/fx](https://github.com/uber-go/fx) — DI-based application framework ☆`7,160`
...
- [samber/oops](https://github.com/samber/oops) — Structured error handling ☆`824`
- [Southclaws/fault](https://github.com/Southclaws/fault) — Composable error wrapping ☆`302`
### File Handling

- [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,533`
- [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,123`
- [pdfcpu/pdfcpu](https://github.com/pdfcpu/pdfcpu) — PDF processor in Go ☆`8,326`
- [spf13/afero](https://github.com/spf13/afero) — Filesystem abstraction for Go ☆`6,502`
- [dundee/gdu](https://github.com/dundee/gdu) — Fast disk usage analyzer ☆`5,124`
- [unidoc/unioffice](https://github.com/unidoc/unioffice) — Office document library ☆`4,758`
...
- [gorilla/csrf](https://github.com/gorilla/csrf) — CSRF prevention middleware ☆`1,167`
...
- [samber/mo](https://github.com/samber/mo) — Monads and FP for Go ☆`3,254`
...
- [gabriel-vasile/mimetype](https://github.com/gabriel-vasile/mimetype) — MIME type detection by magic numbers ☆`1,917`
...
- [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,639`
- [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,072`
- [rs/zerolog](https://github.com/rs/zerolog) — Zero allocation JSON logger ☆`12,076`
- [davecgh/go-spew](https://github.com/davecgh/go-spew) — Deep pretty printer for debugging ☆`6,362`
...
- [Lifailon/lazyjournal](https://github.com/Lifailon/lazyjournal) — TUI for journald, Docker, K8s logs ☆`1,032`
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,841`
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) — Spin up Go projects with popular frameworks ☆`8,521`
...
- [mikestefanello/pagoda](https://github.com/mikestefanello/pagoda) — Full-stack web development starter kit ☆`2,883`
...
- [cilium/ebpf](https://github.com/cilium/ebpf) — eBPF library for Go ☆`7,401`
...
- [go-playground/webhooks](https://github.com/go-playground/webhooks) — Webhook receiver for GitHub, Bitbucket, GitLab, Gogs ☆`1,017`
...
- [anchore/syft](https://github.com/anchore/syft) — SBOM generator for containers ☆`8,158`
...
- [go-git/go-git](https://github.com/go-git/go-git) — Pure Go Git implementation ☆`7,087`
...
- [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,351`
- [go-kit/kit](https://github.com/go-kit/kit) — A standard library for microservices. ☆`27,573`
- [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,266`
- [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,646`
- [smallnest/rpcx](https://github.com/smallnest/rpcx) — Feature-rich RPC framework ☆`8,273`
- [cloudwego/kitex](https://github.com/cloudwego/kitex) — High-performance Go RPC framework ☆`7,790`
...
- [gorilla/mux](https://github.com/gorilla/mux) — Powerful HTTP router ☆`21,750`
- [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,230`
...
- [a-h/templ](https://github.com/a-h/templ) — A language for writing HTML user interfaces in Go. ☆`9,923`
- [valyala/quicktemplate](https://github.com/valyala/quicktemplate) — Fast template engine for Go ☆`3,291`
...
- [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,487`
- [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,827`
- [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,383`
- [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`31,957`
- [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,428`
- [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`12,964`
- [cloudwego/hertz](https://github.com/cloudwego/hertz) — High-performance HTTP framework ☆`6,984`
- [goadesign/goa](https://github.com/goadesign/goa) — Design-first API framework ☆`6,022`
- [apache/dubbo-go](https://github.com/apache/dubbo-go) — Go Implementation For Apache Dubbo . ☆`4,868`
- [goravel/goravel](https://github.com/goravel/goravel) — The full-featured Golang Development Framework skeleton ☆`4,346`
- [danielgtaylor/huma](https://github.com/danielgtaylor/huma) — Huma REST/HTTP API Framework for Golang with OpenAPI 3.1 ☆`3,684`
...
- [templui/templui](https://github.com/templui/templui) — UI components for Templ ☆`1,226`
- [ankorstore/yokai](https://github.com/ankorstore/yokai) — Modular framework for Go apps ☆`806`
- [indeedeng/iwf](https://github.com/indeedeng/iwf) — Workflow-as-code orchestration ☆`627`
- [i-love-flamingo/flamingo-commerce](https://github.com/i-love-flamingo/flamingo-commerce) — Flexible Go web framework ☆`584`
...
- [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`16,992`
...
- [go-co-op/gocron](https://github.com/go-co-op/gocron) — Easy and fluent Go cron scheduling ☆`6,820`
- [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) — Run Background Tasks at Scale ☆`6,380`
...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) — Workflow engine with Web UI ☆`2,944`
...
- [luno/workflow](https://github.com/luno/workflow) — Type-safe workflow orchestration ☆`211`
...
1. [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`158,322`
1. [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,454`
1. [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,487`
1. [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,259`
1. [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,275`
1. [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`68,773`
1. [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`61,921`
1. [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`60,737`
1. [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,443`
1. [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,841`
1. [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`54,628`
1. [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`52,974`
1. [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`52,730`
1. [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,171`
1. [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,566`
1. [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,728`
1. [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`41,938`
1. [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`40,776`
1. [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,517`
1. [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,306`
1. [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,827`
1. [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`37,727`
1. [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`33,735`
1. [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,533`
1. [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,383`
1. [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,351`
1. [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`31,957`
1. [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,733`
1. [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,654`
1. [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,412`
1. [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,303`
1. [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,020`
1. [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,741`
1. [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,528`
1. [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,116`
1. [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,686`
1. [go-kit/kit](https://github.com/go-kit/kit) — A standard library for microservices. ☆`27,573`
1. [sirupsen/logrus](https://github.com/sirupsen/logrus) — Structured, pluggable logging for Go. ☆`25,639`
1. [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,564`
1. [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,266`
1. [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`24,946`
1. [tsenart/vegeta](https://github.com/tsenart/vegeta) — HTTP load testing tool and library. It's over 9000! ☆`24,805`
1. [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,072`
1. [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,780`
1. [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,165`
1. [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,680`
1. [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,646`
1. [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,551`
1. [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,271`
1. [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,766`
1. [gorilla/mux](https://github.com/gorilla/mux) — Powerful HTTP router ☆`21,750`
1. [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,426`
1. [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,230`
1. [samber/lo](https://github.com/samber/lo) — Lodash-style utilities for Go ☆`20,793`
1. [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`20,587`
1. [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,483`
1. [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,123`
1. [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,119`
1. [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,596`
1. [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,506`
1. [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,492`
1. [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,864`
1. [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`18,207`
1. [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,851`
1. [jmoiron/sqlx](https://github.com/jmoiron/sqlx) — Extensions for database/sql ☆`17,432`
1. [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,181`
1. [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`16,992`
1. [ipfs/kubo](https://github.com/ipfs/kubo) — An IPFS implementation in Go ☆`16,853`
1. [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`16,796`
1. [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,589`
1. [fatih/vim-go](https://github.com/fatih/vim-go) — Go development plugin for Vim ☆`16,220`
1. [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`15,851`
1. [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,811`
1. [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,539`
1. [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,428`
1. [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,402`
1. [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,377`
1. [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) — MySQL driver for database/sql ☆`15,359`
1. [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,307`
1. [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,853`
1. [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,849`
1. [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,491`
1. [xtaci/kcptun](https://github.com/xtaci/kcptun) — Quantum-safe secure tunnel ☆`14,321`
1. [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,215`
1. [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,746`
1. [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`13,653`
1. [gizak/termui](https://github.com/gizak/termui) — Golang terminal dashboard ☆`13,496`
1. [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,485`
...
1. [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,078`
1. [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`12,964`
1. [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`12,795`
1. [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,660`
1. [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,597`
1. [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,583`
1. [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,469`
1. [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,357`
1. [rs/zerolog](https://github.com/rs/zerolog) — Zero allocation JSON logger ☆`12,076`
1. [Shopify/toxiproxy](https://github.com/Shopify/toxiproxy) — TCP proxy for chaos testing ☆`11,754`
