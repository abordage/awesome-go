...
![Total Stars](https://img.shields.io/badge/total%20stars-4,967,645-gold)
...
- [sashabaranov/go-openai](https://github.com/sashabaranov/go-openai) — OpenAI API client for Go ☆`10,495`
...
- [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`159,168`
- [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`41,255`
- [tmc/langchaingo](https://github.com/tmc/langchaingo) — LangChain for Go, the easiest way to write LLM-based programs in Go ☆`8,400`
- [maximhq/bifrost](https://github.com/maximhq/bifrost) — Fastest LLM gateway for Go ☆`1,637`
...
- [sjwhitworth/golearn](https://github.com/sjwhitworth/golearn) — Machine Learning for Go ☆`9,456`
...
- [gomlx/gomlx](https://github.com/gomlx/gomlx) — GoMLX: An Accelerated Machine Learning Framework For Go ☆`1,275`
...
- [knights-analytics/hugot](https://github.com/knights-analytics/hugot) — Onnx transformer pipelines in Golang ☆`535`
- [c-bata/goptuna](https://github.com/c-bata/goptuna) — A hyperparameter optimization framework, inspired by Optuna. ☆`273`
## Audio & Video

### Audio

- [ebitengine/oto](https://github.com/ebitengine/oto) — A low-level library to play sound on multiple platforms ☆`1,844`
...
- [hybridgroup/gocv](https://github.com/hybridgroup/gocv) — Computer vision with OpenCV 4 ☆`7,341`
...
- [yeqown/go-qrcode](https://github.com/yeqown/go-qrcode) — Customizable QR code generator ☆`799`
...
- [golang-jwt/jwt](https://github.com/golang-jwt/jwt) — Go implementation of JSON Web Tokens (JWT). ☆`8,826`
- [markbates/goth](https://github.com/markbates/goth) — Multi-provider authentication ☆`6,402`
...
- [zitadel/oidc](https://github.com/zitadel/oidc) — OpenID Connect client and server ☆`1,742`
...
- [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,682`
- [ory/keto](https://github.com/ory/keto) — Customizable permission server ☆`5,241`
- [openfga/openfga](https://github.com/openfga/openfga) — Fine-grained authorization server ☆`4,629`
- [cerbos/cerbos](https://github.com/cerbos/cerbos) — Open core authorization layer ☆`4,186`
## Bots & Chat

### Bot Frameworks

- [tucnak/telebot](https://github.com/tucnak/telebot) — Telebot is a Telegram bot framework in Go. ☆`4,524`
- [go-telegram/bot](https://github.com/go-telegram/bot) — Telegram Bot API Go framework ☆`1,527`
- [mymmrac/telego](https://github.com/mymmrac/telego) — Telegram Bot API library for Go ☆`873`
...
- [bwmarrin/discordgo](https://github.com/bwmarrin/discordgo) — (Golang) Go bindings for Discord ☆`5,736`
...
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`38,127`
- [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,159`
...
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) — Style definitions for nice terminal layouts ☆`10,297`
- [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles) — TUI components for Bubble Tea ☆`7,504`
- [c-bata/go-prompt](https://github.com/c-bata/go-prompt) — Interactive prompts for Go ☆`5,448`
- [pterm/pterm](https://github.com/pterm/pterm) — Modern terminal output library ☆`5,334`
...
- [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,869`
- [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,812`
- [elves/elvish](https://github.com/elves/elvish) — Scripting shell for Go ☆`6,202`
...
- [spf13/pflag](https://github.com/spf13/pflag) — POSIX/GNU-style flags ☆`2,682`
...
- [carapace-sh/carapace-bin](https://github.com/carapace-sh/carapace-bin) — Multi-shell completion binary ☆`1,648`
- [nanovms/ops](https://github.com/nanovms/ops) — Build and run unikernels ☆`1,450`
- [carapace-sh/carapace](https://github.com/carapace-sh/carapace) — Multi-shell completion library ☆`1,098`
...
- [ergo-services/ergo](https://github.com/ergo-services/ergo) — Actor framework with network transparency ☆`4,328`
...
- [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,248`
...
- [rulego/streamsql](https://github.com/rulego/streamsql) — SQL-based stream processing for IoT ☆`52`
## Configuration

- [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,817`
- [caarlos0/env](https://github.com/caarlos0/env) — Parse environment variables to structs ☆`5,928`
- [knadh/koanf](https://github.com/knadh/koanf) — Lightweight config management ☆`3,739`
- [alecthomas/kong](https://github.com/alecthomas/kong) — Command-line parser for Go ☆`2,925`
...
- [gookit/config](https://github.com/gookit/config) — Config management with formats ☆`576`
...
- [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,399`
- [bytedance/sonic](https://github.com/bytedance/sonic) — A blazingly fast JSON serializing & deserializing library ☆`9,015`
...
- [RoaringBitmap/roaring](https://github.com/RoaringBitmap/roaring) — Compressed bitmaps for Go ☆`2,818`
...
- [bits-and-blooms/bloom](https://github.com/bits-and-blooms/bloom) — Bloom filter implementation ☆`2,726`
...
- [dgraph-io/ristretto](https://github.com/dgraph-io/ristretto) — A high performance memory-bound Go cache ☆`6,659`
...
- [VictoriaMetrics/fastcache](https://github.com/VictoriaMetrics/fastcache) — Fast in-memory cache for Go ☆`2,312`
...
- [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,917`
- [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,540`
- [pressly/goose](https://github.com/pressly/goose) — A database migration tool. Supports SQL migrations and Go functions. ☆`9,931`
- [ariga/atlas](https://github.com/ariga/atlas) — Declarative schema migrations with schema-as-code workflows ☆`7,856`
- [amacneil/dbmate](https://github.com/amacneil/dbmate) — A lightweight, framework-agnostic database migration tool. ☆`6,617`
...
- [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`20,613`
...
- [liweiyi88/onedump](https://github.com/liweiyi88/onedump) — Effortless database administration tool ☆`867`
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`62,155`
- [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`42,157`
- [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,579`
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,721`
- [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,088`
- [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,449`
- [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,535`
- [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,238`
- [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,924`
- [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,363`
- [etcd-io/bbolt](https://github.com/etcd-io/bbolt) — An embedded key/value database for Go. ☆`9,304`
- [codenotary/immudb](https://github.com/codenotary/immudb) — Immutable database with SQL ☆`8,891`
- [cockroachdb/pebble](https://github.com/cockroachdb/pebble) — RocksDB/LevelDB inspired key-value database in Go ☆`5,704`
- [rosedblabs/rosedb](https://github.com/rosedblabs/rosedb) — Fast key/value storage engine ☆`4,881`
- [tidwall/buntdb](https://github.com/tidwall/buntdb) — Embeddable in-memory key/value DB ☆`4,824`
- [nalgeon/redka](https://github.com/nalgeon/redka) — Redis re-implemented with SQL ☆`4,443`
...
- [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,441`
- [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,666`
...
- [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,799`
...
- [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,361`
- [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`16,830`
- [aarondl/sqlboiler](https://github.com/aarondl/sqlboiler) — Generate a Go ORM tailored to your database schema. ☆`6,968`
- [uptrace/bun](https://github.com/uptrace/bun) — SQL-first Golang ORM ☆`4,601`
...
- [99designs/gqlgen](https://github.com/99designs/gqlgen) — go generate based graphql server library ☆`10,631`
- [TomWright/dasel](https://github.com/TomWright/dasel) — Query and modify data formats ☆`7,781`
...
- [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,149`
- [denisenkom/go-mssqldb](https://github.com/denisenkom/go-mssqldb) — Microsoft SQL server driver written in go language ☆`1,876`
- [ncruces/go-sqlite3](https://github.com/ncruces/go-sqlite3) — Go bindings to SQLite using wazero ☆`896`
...
- [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,689`
- [Masterminds/squirrel](https://github.com/Masterminds/squirrel) — Fluent SQL generation for golang ☆`7,839`
...
- [doug-martin/goqu](https://github.com/doug-martin/goqu) — SQL builder and query library for golang ☆`2,626`
...
- [elastic/go-elasticsearch](https://github.com/elastic/go-elasticsearch) — The official Go client for Elasticsearch ☆`6,008`
- [ClickHouse/clickhouse-go](https://github.com/ClickHouse/clickhouse-go) — Golang driver for ClickHouse ☆`3,226`
- [sourcegraph/zoekt](https://github.com/sourcegraph/zoekt) — Fast trigram-based code search ☆`1,331`
- [sdqri/effdsl](https://github.com/sdqri/effdsl) — Elasticsearch query builder for golang ☆`34`
## DevOps & Build

### Backup

- [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,681`
- [gilbertchen/duplicacy](https://github.com/gilbertchen/duplicacy) — Cloud backup tool ☆`5,603`
### Build Automation

- [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,662`
- [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,563`
- [joerdav/xc](https://github.com/joerdav/xc) — Markdown defined task runner. ☆`1,365`
...
- [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`33,790`
- [woodpecker-ci/woodpecker](https://github.com/woodpecker-ci/woodpecker) — Simple, powerful CI/CD engine ☆`6,238`
...
- [vladopajic/go-test-coverage](https://github.com/vladopajic/go-test-coverage) — Report test coverage threshold issues ☆`209`
...
- [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,331`
- [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`60,991`
- [ko-build/ko](https://github.com/ko-build/ko) — Build and deploy Go applications ☆`8,298`
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`53,062`
- [moovweb/gvm](https://github.com/moovweb/gvm) — Go Version Manager ☆`11,480`
- [TwiN/gatus](https://github.com/TwiN/gatus) — Automated developer-oriented status page with alerting and incident support ☆`9,603`
- [bitfield/script](https://github.com/bitfield/script) — Making it easy to write shell-like scripts in Go ☆`6,912`
- [fleetdm/fleet](https://github.com/fleetdm/fleet) — Open device management ☆`5,904`
- [taubyte/tau](https://github.com/taubyte/tau) — Fullstack Workspace for Humans & Machines ☆`4,876`
- [megaease/easeprobe](https://github.com/megaease/easeprobe) — Service health monitoring tool ☆`2,290`
- [ajvb/kala](https://github.com/ajvb/kala) — Modern Job Scheduler ☆`2,162`
- [gabrie30/ghorg](https://github.com/gabrie30/ghorg) — Clone entire GitHub orgs ☆`1,925`
...
- [scaleway/scaleway-cli](https://github.com/scaleway/scaleway-cli) — Command Line Interface for Scaleway ☆`948`
...
- [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,547`
- [pomerium/pomerium](https://github.com/pomerium/pomerium) — Pomerium is an identity and context-aware access proxy. ☆`4,628`
- [peak/s5cmd](https://github.com/peak/s5cmd) — Parallel S3 and local filesystem execution tool. ☆`3,831`
- [aptly-dev/aptly](https://github.com/aptly-dev/aptly) — aptly - Debian repository management tool ☆`2,747`
- [KusionStack/kusion](https://github.com/KusionStack/kusion) — Declarative platform orchestrator ☆`1,250`
- [oxyno-zeta/s3-proxy](https://github.com/oxyno-zeta/s3-proxy) — S3 reverse proxy with auth ☆`429`
### Kubernetes

- [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,746`
- [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,356`
- [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,854`
- [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,896`
- [kubeshark/kubeshark](https://github.com/kubeshark/kubeshark) — API traffic analyzer for Kubernetes ☆`11,670`
...
- [kubevela/kubevela](https://github.com/kubevela/kubevela) — The Modern Application Platform. ☆`7,660`
- [k3d-io/k3d](https://github.com/k3d-io/k3d) — Little helper to run CNCF's k3s in Docker ☆`6,199`
- [stefanprodan/podinfo](https://github.com/stefanprodan/podinfo) — Go microservice template for Kubernetes ☆`5,810`
- [apecloud/kubeblocks](https://github.com/apecloud/kubeblocks) — Kubernetes operator for databases ☆`2,949`
...
- [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,615`
...
- [axllent/mailpit](https://github.com/axllent/mailpit) — An email and SMTP testing tool with API for developers ☆`8,450`
- [foxcpp/maddy](https://github.com/foxcpp/maddy) — Composable all-in-one mail server. ☆`5,788`
- [mjl-/mox](https://github.com/mjl-/mox) — Modern secure mail server ☆`5,345`
...
- [wneessen/go-mail](https://github.com/wneessen/go-mail) — Easy to use, yet comprehensive library for sending mails with Go ☆`1,235`
...
- [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,658`
...
- [cosmos/cosmos-sdk](https://github.com/cosmos/cosmos-sdk) — A Framework for Building High Value Public Blockchains ☆`6,899`
...
- [shopspring/decimal](https://github.com/shopspring/decimal) — Arbitrary-precision fixed-point decimal numbers in Go ☆`7,178`
...
- [c9s/bbgo](https://github.com/c9s/bbgo) — The modern cryptocurrency trading bot framework written in Go. ☆`1,589`
- [formancehq/ledger](https://github.com/formancehq/ledger) — The programmable open source core ledger for fintech ☆`1,114`
...
- [stripe/stripe-go](https://github.com/stripe/stripe-go) — Stripe API library for Go ☆`2,502`
...
- [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,757`
- [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,799`
- [therecipe/qt](https://github.com/therecipe/qt) — Qt bindings for Go ☆`10,771`
...
- [energye/energy](https://github.com/energye/energy) — CEF-based GUI framework ☆`568`
...
- [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`12,842`
- [fogleman/nes](https://github.com/fogleman/nes) — NES emulator written in Go. ☆`5,634`
- [topfreegames/pitaya](https://github.com/topfreegames/pitaya) — Game server with clustering support ☆`2,711`
- [xiaonanln/goworld](https://github.com/xiaonanln/goworld) — Distributed game server engine ☆`2,698`
...
- [mlange-42/ark](https://github.com/mlange-42/ark) — Ark -- Archetype-based Entity Component System (ECS) for Go. ☆`199`
...
- [gopherjs/gopherjs](https://github.com/gopherjs/gopherjs) — A compiler from Go to JavaScript for running Go code in a browser ☆`13,096`
...
- [visualfc/liteide](https://github.com/visualfc/liteide) — LiteIDE is a simple, open source, cross-platform Go IDE. ☆`7,744`
- [nsf/gocode](https://github.com/nsf/gocode) — An autocompletion daemon for the Go programming language ☆`5,002`
- [golang/vscode-go](https://github.com/golang/vscode-go) — Go extension for Visual Studio Code ☆`4,179`
...
- [go-swagger/go-swagger](https://github.com/go-swagger/go-swagger) — Swagger 2.0 implementation for go ☆`9,919`
- [ondrajz/go-callvis](https://github.com/ondrajz/go-callvis) — Visualize call graph of a Go program using Graphviz ☆`6,445`
- [Zxilly/go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) — Analyze compiled Go binary size ☆`1,877`
...
- [iyashjayesh/monigo](https://github.com/iyashjayesh/monigo) — Performance monitoring library ☆`392`
...
- [shirou/gopsutil](https://github.com/shirou/gopsutil) — psutil for golang ☆`11,651`
...
- [lf-edge/ekuiper](https://github.com/lf-edge/ekuiper) — Lightweight data stream processing engine for IoT edge ☆`1,668`
...
- [hashicorp/raft](https://github.com/hashicorp/raft) — Golang implementation of the Raft consensus protocol ☆`8,893`
...
- [miekg/dns](https://github.com/miekg/dns) — DNS library in Go ☆`8,608`
- [0xERR0R/blocky](https://github.com/0xERR0R/blocky) — DNS ad-blocker for local networks ☆`5,873`
...
- [luraproject/lura](https://github.com/luraproject/lura) — Ultra-performant API gateway ☆`6,717`
...
- [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,194`
...
- [go-resty/resty](https://github.com/go-resty/resty) — Simple HTTP, REST, and SSE client library for Go ☆`11,460`
- [imroc/req](https://github.com/imroc/req) — Simple Go HTTP client with Black Magic ☆`4,727`
...
- [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`69,065`
- [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,684`
- [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`55,070`
- [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,287`
- [drakkan/sftpgo](https://github.com/drakkan/sftpgo) — Full-featured SFTP/FTP/HTTP server ☆`11,567`
- [adnanh/webhook](https://github.com/adnanh/webhook) — Lightweight webhook server ☆`11,478`
...
- [charmbracelet/wish](https://github.com/charmbracelet/wish) — Make SSH apps, just like that! ☆`4,699`
- [getfider/fider](https://github.com/getfider/fider) — Open platform to collect and prioritize feedback ☆`3,997`
...
- [anacrolix/torrent](https://github.com/anacrolix/torrent) — Full-featured BitTorrent client package and utilities ☆`5,932`
- [dragonflyoss/dragonfly](https://github.com/dragonflyoss/dragonfly) — P2P-based container image distribution ☆`2,961`
...
- [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`15,901`
- [quic-go/quic-go](https://github.com/quic-go/quic-go) — A production-ready QUIC implementation in pure Go ☆`11,313`
- [google/gopacket](https://github.com/google/gopacket) — Provides packet processing capabilities for Go ☆`6,712`
- [osrg/gobgp](https://github.com/osrg/gobgp) — BGP implemented in the Go Programming Language ☆`3,956`
...
- [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,704`
...
- [gliderlabs/ssh](https://github.com/gliderlabs/ssh) — Easy SSH servers in Golang ☆`4,063`
...
- [xtaci/kcptun](https://github.com/xtaci/kcptun) — Quantum-safe secure tunnel ☆`14,456`
- [panjf2000/gnet](https://github.com/panjf2000/gnet) — High-performance event-loop network ☆`11,036`
- [cloudwego/netpoll](https://github.com/cloudwego/netpoll) — High-performance I/O framework ☆`4,510`
- [xtaci/kcp-go](https://github.com/xtaci/kcp-go) — A crypto-secure Reliable-UDP library for Golang with FEC support. ☆`4,432`
...
- [xtaci/gaio](https://github.com/xtaci/gaio) — High-performance, minimalist async-io (proactor) networking for Golang. ☆`855`
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,613`
- [xjasonlyu/tun2socks](https://github.com/xjasonlyu/tun2socks) — TUN to SOCKS proxy ☆`4,790`
- [songgao/water](https://github.com/songgao/water) — A simple TUN/TAP library written in native Go. ☆`2,119`
- [yosebyte/nodepass](https://github.com/yosebyte/nodepass) — Secure TCP/UDP tunneling with TLS ☆`1,980`
## Queues & Pub/Sub

### Brokers

- [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,946`
...
- [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,729`
- [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,371`
- [centrifugal/centrifugo](https://github.com/centrifugal/centrifugo) — Scalable real-time messaging server ☆`9,711`
- [ThreeDotsLabs/watermill](https://github.com/ThreeDotsLabs/watermill) — Building event-driven applications the easy way in Go. ☆`9,408`
...
- [nats-io/nats.go](https://github.com/nats-io/nats.go) — Golang client for NATS, the cloud native messaging system. ☆`6,361`
- [dunglas/mercure](https://github.com/dunglas/mercure) — Server-Sent Events hub ☆`5,159`
...
- [olahol/melody](https://github.com/olahol/melody) — Minimalist websocket framework for Go ☆`4,046`
...
- [containrrr/shoutrrr](https://github.com/containrrr/shoutrrr) — Notification library for gophers and their furry friends. ☆`1,458`
...
- [php/frankenphp](https://github.com/php/frankenphp) — The modern PHP app server ☆`10,625`
- [expr-lang/expr](https://github.com/expr-lang/expr) — Expression evaluation for Go ☆`7,594`
- [yuin/gopher-lua](https://github.com/yuin/gopher-lua) — Lua VM and compiler in Go ☆`6,820`
- [dop251/goja](https://github.com/dop251/goja) — ECMAScript engine in pure Go ☆`6,679`
- [d5/tengo](https://github.com/d5/tengo) — Fast script language for Go ☆`3,762`
- [Shopify/go-lua](https://github.com/Shopify/go-lua) — Lua VM in Go ☆`3,398`
- [google/cel-go](https://github.com/google/cel-go) — Common Expression Language for Go ☆`2,817`
...
- [oapi-codegen/oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) — Generate Go code from OpenAPI 3 specs ☆`7,961`
- [dave/jennifer](https://github.com/dave/jennifer) — Code generator for Go ☆`3,594`
- [hexdigest/gowrap](https://github.com/hexdigest/gowrap) — Generate interface decorators ☆`1,303`
...
- [go-acme/lego](https://github.com/go-acme/lego) — Let's Encrypt/ACME client and library written in Go ☆`9,137`
- [caddyserver/certmagic](https://github.com/caddyserver/certmagic) — Automatic HTTPS certificate management ☆`5,418`
...
- [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,920`
- [authzed/spicedb](https://github.com/authzed/spicedb) — Zanzibar-inspired permissions DB ☆`6,335`
...
- [Ullaakut/cameradar](https://github.com/Ullaakut/cameradar) — Cameradar hacks its way into RTSP videosurveillance cameras ☆`4,824`
...
- [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) — AI-powered honeypot framework ☆`1,807`
...
- [sigstore/cosign](https://github.com/sigstore/cosign) — Code signing and transparency for containers and binaries ☆`5,561`
- [openziti/ziti](https://github.com/openziti/ziti) — Zero trust networking platform ☆`3,801`
- [spiffe/spire](https://github.com/spiffe/spire) — The SPIFFE Runtime Environment ☆`2,170`
...
- [boyter/scc](https://github.com/boyter/scc) — Fast code counter and stats ☆`7,946`
- [mgechev/revive](https://github.com/mgechev/revive) — Fast, extensible Go linter ☆`5,378`
- [kisielk/errcheck](https://github.com/kisielk/errcheck) — errcheck checks that you checked errors. ☆`2,467`
...
- [vektra/mockery](https://github.com/vektra/mockery) — Mock code autogenerator for Go ☆`6,940`
- [DATA-DOG/go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) — SQL mock driver for testing ☆`6,507`
- [brianvoe/gofakeit](https://github.com/brianvoe/gofakeit) — Random fake data generator written in go ☆`5,282`
- [uber-go/mock](https://github.com/uber-go/mock) — GoMock is a mocking framework for the Go programming language. ☆`3,223`
...
- [maxbrunsfeld/counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) — Generate type-safe test doubles ☆`1,113`
...
- [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,337`
...
- [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,632`
- [go-rod/rod](https://github.com/go-rod/rod) — Chrome DevTools driver for scraping ☆`6,542`
- [sensepost/gowitness](https://github.com/sensepost/gowitness) — Web screenshot utility with Chrome ☆`4,120`
...
- [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,638`
- [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`15,083`
- [Shopify/toxiproxy](https://github.com/Shopify/toxiproxy) — TCP proxy for chaos testing ☆`11,768`
- [testcontainers/testcontainers-go](https://github.com/testcontainers/testcontainers-go) — Docker containers for integration tests ☆`4,585`
- [google/go-cmp](https://github.com/google/go-cmp) — Package for comparing Go values in tests ☆`4,572`
- [gavv/httpexpect](https://github.com/gavv/httpexpect) — End-to-end HTTP and REST API testing for Go. ☆`2,702`
- [cucumber/godog](https://github.com/cucumber/godog) — Cucumber for golang ☆`2,576`
...
- [go-testfixtures/testfixtures](https://github.com/go-testfixtures/testfixtures) — Rails-like test fixtures for Go ☆`1,211`
- [fergusstrange/embedded-postgres](https://github.com/fergusstrange/embedded-postgres) — Embedded PostgreSQL for testing ☆`1,106`
- [chapar-rest/chapar](https://github.com/chapar-rest/chapar) — API testing for HTTP and gRPC ☆`680`
...
- [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,568`
- [gookit/validate](https://github.com/gookit/validate) — Struct and data validation ☆`1,123`
- [Oudwins/zog](https://github.com/Oudwins/zog) — Zod-inspired schema validation ☆`1,106`
...
- [dustin/go-humanize](https://github.com/dustin/go-humanize) — Human-friendly unit formatting ☆`4,766`
...
- [BurntSushi/toml](https://github.com/BurntSushi/toml) — TOML parser with reflection ☆`4,876`
- [yuin/goldmark](https://github.com/yuin/goldmark) — Markdown parser for Go ☆`4,516`
- [JohannesKaufmann/html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) — Convert HTML to Markdown ☆`3,323`
...
- [gosimple/slug](https://github.com/gosimple/slug) — URL-friendly slugify ☆`1,307`
...
- [mvdan/sh](https://github.com/mvdan/sh) — Shell parser and formatter ☆`8,380`
...
- [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`24,991`
- [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,873`
...
- [blevesearch/bleve](https://github.com/blevesearch/bleve) — Text/numeric/geo/vector indexing library ☆`10,884`
...
- [googleapis/google-api-go-client](https://github.com/googleapis/google-api-go-client) — Auto-generated Google APIs for Go. ☆`4,374`
- [aws/aws-sdk-go-v2](https://github.com/aws/aws-sdk-go-v2) — AWS SDK for the Go programming language. ☆`3,414`
...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,465`
...
- [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,791`
- [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`53,096`
- [xo/usql](https://github.com/xo/usql) — Universal SQL CLI ☆`9,763`
- [minio/mc](https://github.com/minio/mc) — Unix utilities for object stores ☆`3,331`
- [joshmedeski/sesh](https://github.com/joshmedeski/sesh) — Terminal session manager ☆`1,564`
- [itchyny/bed](https://github.com/itchyny/bed) — Binary editor in Go ☆`1,344`
- [owenthereal/upterm](https://github.com/owenthereal/upterm) — Instant terminal sharing ☆`1,085`
...
- [hedhyw/json-log-viewer](https://github.com/hedhyw/json-log-viewer) — Interactive JSON log viewer ☆`204`
...
- [duke-git/lancet](https://github.com/duke-git/lancet) — Comprehensive util library ☆`5,247`
- [darccio/mergo](https://github.com/darccio/mergo) — Merge Go structs and maps ☆`3,078`
- [goforj/godump](https://github.com/goforj/godump) — Pretty-printer for Go structs ☆`1,569`
...
- [jmoiron/sqlx](https://github.com/jmoiron/sqlx) — Extensions for database/sql ☆`17,445`
...
- [uber-go/fx](https://github.com/uber-go/fx) — DI-based application framework ☆`7,202`
- [uber-go/dig](https://github.com/uber-go/dig) — Reflection-based DI toolkit ☆`4,419`
...
- [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,791`
- [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,177`
- [pdfcpu/pdfcpu](https://github.com/pdfcpu/pdfcpu) — PDF processor in Go ☆`8,363`
...
- [gabriel-vasile/mimetype](https://github.com/gabriel-vasile/mimetype) — MIME type detection by magic numbers ☆`1,926`
...
- [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,111`
- [rs/zerolog](https://github.com/rs/zerolog) — Zero allocation JSON logger ☆`12,101`
...
- [gookit/slog](https://github.com/gookit/slog) — Configurable logging library ☆`530`
...
- [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,969`
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) — Spin up Go projects with popular frameworks ☆`8,559`
- [ardanlabs/service](https://github.com/ardanlabs/service) — K8s service starter kit ☆`3,923`
- [Shpota/goxygen](https://github.com/Shpota/goxygen) — Generate full-stack web projects ☆`3,606`
- [mikestefanello/pagoda](https://github.com/mikestefanello/pagoda) — Full-stack web development starter kit ☆`2,891`
...
- [failsafe-go/failsafe-go](https://github.com/failsafe-go/failsafe-go) — Fault tolerance patterns ☆`2,120`
...
- [abhimanyu003/sttr](https://github.com/abhimanyu003/sttr) — CLI string operations ☆`1,273`
...
- [cilium/ebpf](https://github.com/cilium/ebpf) — eBPF library for Go ☆`7,450`
...
- [oklog/ulid](https://github.com/oklog/ulid) — ULID implementation ☆`4,960`
...
- [google/go-github](https://github.com/google/go-github) — Go library for accessing the GitHub v3 API ☆`11,069`
- [shurcooL/githubv4](https://github.com/shurcooL/githubv4) — GitHub GraphQL API v4 client ☆`1,177`
- [go-playground/webhooks](https://github.com/go-playground/webhooks) — Webhook receiver for GitHub, Bitbucket, GitLab, Gogs ☆`1,023`
...
- [anchore/syft](https://github.com/anchore/syft) — SBOM generator for containers ☆`8,205`
...
- [go-git/go-git](https://github.com/go-git/go-git) — Pure Go Git implementation ☆`7,116`
...
- [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,435`
- [go-kit/kit](https://github.com/go-kit/kit) — A standard library for microservices. ☆`27,581`
- [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,321`
- [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,663`
- [smallnest/rpcx](https://github.com/smallnest/rpcx) — Feature-rich RPC framework ☆`8,272`
- [cloudwego/kitex](https://github.com/cloudwego/kitex) — High-performance Go RPC framework ☆`7,814`
- [go-dev-frame/sponge](https://github.com/go-dev-frame/sponge) — Code generation framework for Go ☆`2,758`
...
- [tdewolff/minify](https://github.com/tdewolff/minify) — Go minifiers for web formats ☆`4,046`
...
- [gorilla/mux](https://github.com/gorilla/mux) — Powerful HTTP router ☆`21,765`
- [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,321`
...
- [a-h/templ](https://github.com/a-h/templ) — A language for writing HTML user interfaces in Go. ☆`9,962`
...
- [go-sprout/sprout](https://github.com/go-sprout/sprout) — Template functions for Go ☆`200`
...
- [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,662`
- [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,939`
- [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,390`
- [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`32,018`
- [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,387`
- [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`12,988`
...
- [apache/dubbo-go](https://github.com/apache/dubbo-go) — Go Implementation For Apache Dubbo . ☆`4,877`
- [goravel/goravel](https://github.com/goravel/goravel) — The full-featured Golang Development Framework skeleton ☆`4,383`
- [danielgtaylor/huma](https://github.com/danielgtaylor/huma) — Huma REST/HTTP API Framework for Golang with OpenAPI 3.1 ☆`3,723`
...
- [go-fuego/fuego](https://github.com/go-fuego/fuego) — Web framework with OpenAPI 3 ☆`1,627`
- [templui/templui](https://github.com/templui/templui) — UI components for Templ ☆`1,289`
- [savsgio/atreugo](https://github.com/savsgio/atreugo) — Micro web framework on fasthttp ☆`1,299`
- [ankorstore/yokai](https://github.com/ankorstore/yokai) — Modular framework for Go apps ☆`813`
...
- [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,056`
...
- [go-co-op/gocron](https://github.com/go-co-op/gocron) — Easy and fluent Go cron scheduling ☆`6,844`
- [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) — Run Background Tasks at Scale ☆`6,430`
...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) — Workflow engine with Web UI ☆`2,976`
...
1. [ollama/ollama](https://github.com/ollama/ollama) — Run LLMs locally ☆`159,168`
1. [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) — Production-Grade Container Scheduling and Management ☆`119,746`
1. [gin-gonic/gin](https://github.com/gin-gonic/gin) — High-performance HTTP framework ☆`87,662`
1. [junegunn/fzf](https://github.com/junegunn/fzf) — Command-line fuzzy finder ☆`76,791`
1. [moby/moby](https://github.com/moby/moby) — Container ecosystem components ☆`71,331`
1. [caddyserver/caddy](https://github.com/caddyserver/caddy) — Multi-platform web server with HTTPS ☆`69,065`
1. [prometheus/prometheus](https://github.com/prometheus/prometheus) — The Prometheus monitoring system and time series database. ☆`62,155`
1. [traefik/traefik](https://github.com/traefik/traefik) — The Cloud Native Application Proxy ☆`60,991`
1. [minio/minio](https://github.com/minio/minio) — High-performance object storage ☆`59,684`
1. [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) — Open Source realtime backend in 1 file ☆`55,070`
1. [golang-standards/project-layout](https://github.com/golang-standards/project-layout) — Standard Go project layout ☆`54,969`
1. [wagoodman/dive](https://github.com/wagoodman/dive) — Explore Docker image layers ☆`53,096`
1. [go-gitea/gitea](https://github.com/go-gitea/gitea) — Self-hosted Git service ☆`53,062`
1. [etcd-io/etcd](https://github.com/etcd-io/etcd) — Distributed key-value store ☆`51,287`
1. [ethereum/go-ethereum](https://github.com/ethereum/go-ethereum) — Go implementation of the Ethereum protocol ☆`50,658`
1. [spf13/cobra](https://github.com/spf13/cobra) — A Commander for modern Go CLI interactions ☆`42,869`
1. [milvus-io/milvus](https://github.com/milvus-io/milvus) — Cloud-native vector database ☆`42,157`
1. [mudler/LocalAI](https://github.com/mudler/LocalAI) — Local OpenAI alternative ☆`41,255`
1. [pingcap/tidb](https://github.com/pingcap/tidb) — Cloud-native distributed SQL DB ☆`39,579`
1. [go-gorm/gorm](https://github.com/go-gorm/gorm) — The fantastic ORM library for Golang, aims to be developer friendly ☆`39,361`
1. [gofiber/fiber](https://github.com/gofiber/fiber) — Express inspired web framework written in Go ☆`38,939`
1. [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) — A powerful little TUI framework ☆`38,127`
1. [schollz/croc](https://github.com/schollz/croc) — Easily and securely send things from one computer to another ☆`33,791`
1. [harness/harness](https://github.com/harness/harness) — End-to-end developer platform ☆`33,790`
1. [zeromicro/go-zero](https://github.com/zeromicro/go-zero) — Microservices framework with CLI tools ☆`32,435`
1. [beego/beego](https://github.com/beego/beego) — High-performance web framework ☆`32,390`
1. [labstack/echo](https://github.com/labstack/echo) — High performance, minimalist Go web framework ☆`32,018`
1. [k3s-io/k3s](https://github.com/k3s-io/k3s) — Lightweight Kubernetes ☆`31,854`
1. [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) — Cloud native distributed SQL database ☆`31,721`
1. [restic/restic](https://github.com/restic/restic) — Fast, secure backup program ☆`31,681`
1. [kubernetes/minikube](https://github.com/kubernetes/minikube) — Run Kubernetes locally ☆`31,356`
1. [influxdata/influxdb](https://github.com/influxdata/influxdb) — Scalable datastore for metrics, events, and real-time analytics ☆`31,088`
1. [spf13/viper](https://github.com/spf13/viper) — Go configuration with fangs ☆`29,817`
1. [grafana/k6](https://github.com/grafana/k6) — A modern load testing tool, using Go and JavaScript ☆`29,615`
1. [seaweedfs/seaweedfs](https://github.com/seaweedfs/seaweedfs) — Fast distributed storage for blobs ☆`29,441`
1. [fyne-io/fyne](https://github.com/fyne-io/fyne) — Cross platform GUI toolkit in Go inspired by Material Design ☆`27,757`
...
1. [stretchr/testify](https://github.com/stretchr/testify) — Assertions and mocks for testing ☆`25,638`
1. [go-kratos/kratos](https://github.com/go-kratos/kratos) — Your ultimate Go microservices framework for the cloud-native era. ☆`25,321`
1. [gocolly/colly](https://github.com/gocolly/colly) — Web scraping framework for Go ☆`24,991`
1. [tsenart/vegeta](https://github.com/tsenart/vegeta) — HTTP load testing tool and library. It's over 9000! ☆`24,828`
1. [uber-go/zap](https://github.com/uber-go/zap) — Fast structured logging ☆`24,111`
1. [urfave/cli](https://github.com/urfave/cli) — Fast CLI framework for Go ☆`23,812`
1. [valyala/fasthttp](https://github.com/valyala/fasthttp) — Fast HTTP package for Go ☆`23,194`
1. [grpc/grpc-go](https://github.com/grpc/grpc-go) — The Go language implementation of gRPC. HTTP/2 based RPC ☆`22,704`
1. [micro/go-micro](https://github.com/micro/go-micro) — A Go microservices framework ☆`22,663`
1. [air-verse/air](https://github.com/air-verse/air) — Live reload for Go apps ☆`22,662`
1. [jaegertracing/jaeger](https://github.com/jaegertracing/jaeger) — Distributed tracing platform ☆`22,337`
1. [redis/go-redis](https://github.com/redis/go-redis) — Redis Go client ☆`21,799`
1. [gorilla/mux](https://github.com/gorilla/mux) — Powerful HTTP router ☆`21,765`
1. [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) — high-performance graph database for real-time use cases ☆`21,449`
1. [go-chi/chi](https://github.com/go-chi/chi) — Lightweight idiomatic HTTP router ☆`21,321`
1. [FiloSottile/age](https://github.com/FiloSottile/age) — Simple encryption tool ☆`20,920`
1. [samber/lo](https://github.com/samber/lo) — Lodash-style utilities for Go ☆`20,834`
1. [vitessio/vitess](https://github.com/vitessio/vitess) — Database clustering for MySQL ☆`20,613`
1. [qax-os/excelize](https://github.com/qax-os/excelize) — Excel XLSX library for Go ☆`20,177`
1. [antonmedv/fx](https://github.com/antonmedv/fx) — Terminal JSON viewer & processor ☆`20,159`
1. [casbin/casbin](https://github.com/casbin/casbin) — Authorization library for Go ☆`19,682`
1. [go-playground/validator](https://github.com/go-playground/validator) — Struct and field validation for Go ☆`19,568`
1. [dolthub/dolt](https://github.com/dolthub/dolt) — Dolt – Git for Data ☆`19,535`
1. [nats-io/nats-server](https://github.com/nats-io/nats-server) — High-performance NATS message server ☆`18,946`
1. [golangci/golangci-lint](https://github.com/golangci/golangci-lint) — Fast linters runner for Go ☆`18,285`
1. [golang-migrate/migrate](https://github.com/golang-migrate/migrate) — Database migrations. CLI and Golang library. ☆`17,917`
1. [jmoiron/sqlx](https://github.com/jmoiron/sqlx) — Extensions for database/sql ☆`17,445`
1. [rqlite/rqlite](https://github.com/rqlite/rqlite) — Lightweight distributed SQLite ☆`17,238`
1. [tinygo-org/tinygo](https://github.com/tinygo-org/tinygo) — Go compiler for microcontrollers ☆`17,056`
1. [ipfs/kubo](https://github.com/ipfs/kubo) — An IPFS implementation in Go ☆`16,873`
1. [ent/ent](https://github.com/ent/ent) — An entity framework for Go ☆`16,830`
1. [sqlc-dev/sqlc](https://github.com/sqlc-dev/sqlc) — Generate type-safe code from SQL ☆`16,689`
1. [fatih/vim-go](https://github.com/fatih/vim-go) — Go development plugin for Vim ☆`16,225`
1. [VictoriaMetrics/VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) — Fast time series database and monitoring ☆`15,924`
1. [pion/webrtc](https://github.com/pion/webrtc) — Pure Go implementation of the WebRTC API ☆`15,901`
1. [hashicorp/packer](https://github.com/hashicorp/packer) — Build machine images from config ☆`15,547`
1. [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) — Release engineering simplified ☆`15,465`
1. [tidwall/gjson](https://github.com/tidwall/gjson) — Fast JSON value extraction ☆`15,399`
1. [gofr-dev/gofr](https://github.com/gofr-dev/gofr) — Microservice framework for Go ☆`15,387`
1. [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) — MySQL driver for database/sql ☆`15,377`
1. [dgraph-io/badger](https://github.com/dgraph-io/badger) — Fast key-value DB in Go. ☆`15,363`
1. [keploy/keploy](https://github.com/keploy/keploy) — API testing with auto mocks ☆`15,083`
1. [kubernetes-sigs/kind](https://github.com/kubernetes-sigs/kind) — Kubernetes IN Docker - local clusters for testing Kubernetes ☆`14,896`
1. [PuerkitoBio/goquery](https://github.com/PuerkitoBio/goquery) — jQuery-like HTML manipulation ☆`14,873`
1. [go-task/task](https://github.com/go-task/task) — A task runner / simpler Make alternative written in Go ☆`14,563`
1. [xtaci/kcptun](https://github.com/xtaci/kcptun) — Quantum-safe secure tunnel ☆`14,456`
1. [panjf2000/ants](https://github.com/panjf2000/ants) — ants is the most powerful and reliable pooling solution for Go. ☆`14,248`
1. [webview/webview](https://github.com/webview/webview) — Tiny webview library for Go ☆`13,799`
1. [bytebase/bytebase](https://github.com/bytebase/bytebase) — Database DevSecOps platform ☆`13,540`
...
1. [jackc/pgx](https://github.com/jackc/pgx) — PostgreSQL driver and toolkit for Go ☆`13,149`
1. [gopherjs/gopherjs](https://github.com/gopherjs/gopherjs) — A compiler from Go to JavaScript for running Go code in a browser ☆`13,096`
1. [gogf/gf](https://github.com/gogf/gf) — Powerful full-stack framework ☆`12,988`
1. [hajimehoshi/ebiten](https://github.com/hajimehoshi/ebiten) — A dead simple 2D game engine for Go ☆`12,842`
1. [hibiken/asynq](https://github.com/hibiken/asynq) — Simple, reliable, and efficient distributed task queue in Go ☆`12,729`
1. [juicedata/juicefs](https://github.com/juicedata/juicefs) — Distributed POSIX filesystem ☆`12,666`
1. [chromedp/chromedp](https://github.com/chromedp/chromedp) — Chrome DevTools Protocol driver ☆`12,632`
1. [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) — Cloudflare Tunnel client ☆`12,613`
1. [IBM/sarama](https://github.com/IBM/sarama) — Sarama is a Go library for Apache Kafka. ☆`12,371`
1. [rs/zerolog](https://github.com/rs/zerolog) — Zero allocation JSON logger ☆`12,101`
1. [Shopify/toxiproxy](https://github.com/Shopify/toxiproxy) — TCP proxy for chaos testing ☆`11,768`
